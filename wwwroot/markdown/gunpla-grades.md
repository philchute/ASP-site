...
*   **Detail**: Good
*   **Notes**: High Grade was introduced in 1990 and at the time was the highest and most detailed grade, introducing the snap-together construction and different colored parts which are now standard for all grades. Now it is one of the simplest grades, with a huge range of models.
* **HGUC**: High Grade Universal Century - The widest line of HG kits. Originally featured only Mobile Suits from the Universal Century timeline, but starting in 2014 this line was expanded to include all timelines (with those kits sometimes labeled as **HGAC**, **HGAW**, **HGCC**, **HGCE**, and **HGFC**), though lately each new series has again been getting its own numbered line of HG kits. The packaging for HGUC includes a colored square before the model number to indicate the series the kit is from:

| Color                                                        | Series                                 |
|--------------------------------------------------------------|----------------------------------------|
| <span style="color: #FDB813;">&#9632;</span> Yellow-Orange | Mobile Suit Gundam, MSV, 08th MS Team, MS IGLOO, Harmony of Gundam, Blue Destiny, Battlefield Record U.C. 0081, Requiem for Vengeance |
| <span style="color: #8DB600;">&#9632;</span> Light Green   | Gundam 0080: War in the Pocket         |
| <span style="color: #0047AB;">&#9632;</span> Blue          | Gundam 0083: Stardust Memory           |
| <span style="color: #008000;">&#9632;</span> Green         | Zeta Gundam, Zeta MSV, Advance of Zeta |
| <span style="color: #FF8C00;">&#9632;</span> Orange        | Gundam ZZ , Moon Gundam                |
| <span style="color: #00FFFF;">&#9632;</span> Cyan          | Gundam Sentinel                        |
| <span style="color: #FF0000;">&#9632;</span> Red           | Char's Counterattack, Gundam UC, Gundam UC MSV, Twilight Axis, Gundam NT, Hathaway |
| <span style="color: #B0E0E6;">&#9632;</span> Pale-Blue     | Gundam F91, Crossbone Gundam           |
| <span style="color: #FFFF00;">&#9632;</span> Yellow        | Victory Gundam                         |
| <span style="color: #FF4500;">&#9632;</span> Red-Orange    | G Gundam                               |
| <span style="color: #800080;">&#9632;</span> Purple        | Gundam Wing                            |
| <span style="color: #66e4f5;">&#9632;</span> Sky-Blue      | Gundam X                               |
| <span style="color: #FFFFFF;">&#9632;</span> White         | Turn A Gundam                          |
| <span style="color: #000080;">&#9632;</span> Dark-Blue     | Gundam SEED                            |
| <span style="color: #0000FF;">&#9632;</span> Gloss-Blue    | Extreme Vs                             |
...
*   **Detail**: High
*   **Notes**: Introduced in 1995 this grade features larger models with more detail and greater articulation. This has become one of the most popular grades for building and collecting. Beginning in 2020 there is a sub-line of redesigned MG kits called **MGEX** Master Grade Extreme.
...
*   **Detail**: High
*   **Notes**: Released from 2001 to 2007 this line of kits features space craft and support vehicles at either 1/144 or 1/1700 scale.

### SD (Super Deformed)
*   **Scale**: Non-scale (Chibi style)
*   **Complexity**: Beginner
*   **Detail**: Low
*   **Notes**: Cute, big-headed proportions. I like making the SD model as a palette cleanser after completing a Mobile Suit at a larger grade.
