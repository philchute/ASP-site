...
namespace ASP_site.Data.Initializers {
  public static class ComicInitializer {
    public static ComicIssue[] GetComicIssues() {
      ...
      issues.Add(new ComicIssue { IssueID = "batgirl-vol-4-35", SeriesTitle = "Batgirl (vol. 4)", IssueNumber = "35", Description = "Batgirl (vol. 4) #35" });
      issues.Add(new ComicIssue { IssueID = "batgirl-vol-4-36", SeriesTitle = "Batgirl (vol. 4)", IssueNumber = "36", Description = "Batgirl (vol. 4) #36" });
      issues.Add(new ComicIssue { IssueID = "batgirl-vol-4-37", SeriesTitle = "Batgirl (vol. 4)", IssueNumber = "37", Description = "Batgirl (vol. 4) #37" });
      issues.Add(new ComicIssue { IssueID = "batgirl-vol-4-38", SeriesTitle = "Batgirl (vol. 4)", IssueNumber = "38", Description = "Batgirl (vol. 4) #38" });
      issues.Add(new ComicIssue { IssueID = "batgirl-vol-4-39", SeriesTitle = "Batgirl (vol. 4)", IssueNumber = "39", Description = "Batgirl (vol. 4) #39" });
      issues.Add(new ComicIssue { IssueID = "batgirl-vol-4-40", SeriesTitle = "Batgirl (vol. 4)", IssueNumber = "40", Description = "Batgirl (vol. 4) #40" });
      issues.Add(new ComicIssue { IssueID = "batgirl-vol-4-41", SeriesTitle = "Batgirl (vol. 4)", IssueNumber = "41", Description = "Batgirl (vol. 4) #41" });
      issues.Add(new ComicIssue { IssueID = "batgirl-vol-4-42", SeriesTitle = "Batgirl (vol. 4)", IssueNumber = "42", Description = "Batgirl (vol. 4) #42" });
      issues.Add(new ComicIssue { IssueID = "batgirl-vol-4-43", SeriesTitle = "Batgirl (vol. 4)", IssueNumber = "43", Description = "Batgirl (vol. 4) #43" });
      issues.Add(new ComicIssue { IssueID = "batgirl-vol-4-44", SeriesTitle = "Batgirl (vol. 4)", IssueNumber = "44", Description = "Batgirl (vol. 4) #44" });
      issues.Add(new ComicIssue { IssueID = "batgirl-vol-4-45", SeriesTitle = "Batgirl (vol. 4)", IssueNumber = "45", Description = "Batgirl (vol. 4) #45" });
      issues.Add(new ComicIssue { IssueID = "annual-batgirl-3", SeriesTitle = "Annual #3", IssueNumber = "3", Description = "Annual #3" });
      issues.Add(new ComicIssue { IssueID = "secret-origins-10", SeriesTitle = "Secret Origins", IssueNumber = "10", Description = "Secret Origins #10" });
      issues.Add(new ComicIssue { IssueID = "dc-sneak-peek-batgirl-1", SeriesTitle = "DC Sneak Peek: Batgirl", IssueNumber = "1", Description = "DC Sneak Peek: Batgirl #1" });
      issues.Add(new ComicIssue { IssueID = "catwoman-when-in-rome-1", SeriesTitle = "Catwoman: When in Rome", IssueNumber = "1", Description = "Catwoman: When in Rome #1" });
      issues.Add(new ComicIssue { IssueID = "catwoman-when-in-rome-2", SeriesTitle = "Catwoman: When in Rome", IssueNumber = "2", Description = "Catwoman: When in Rome #2" });
      issues.Add(new ComicIssue { IssueID = "catwoman-when-in-rome-3", SeriesTitle = "Catwoman: When in Rome", IssueNumber = "3", Description = "Catwoman: When in Rome #3" });
      issues.Add(new ComicIssue { IssueID = "catwoman-when-in-rome-4", SeriesTitle = "Catwoman: When in Rome", IssueNumber = "4", Description = "Catwoman: When in Rome #4" });
      issues.Add(new ComicIssue { IssueID = "catwoman-when-in-rome-5", SeriesTitle = "Catwoman: When in Rome", IssueNumber = "5", Description = "Catwoman: When in Rome #5" });
      issues.Add(new ComicIssue { IssueID = "catwoman-when-in-rome-6", SeriesTitle = "Catwoman: When in Rome", IssueNumber = "6", Description = "Catwoman: When in Rome #6" });
      issues.Add(new ComicIssue { IssueID = "vertigo-winters-edge-3", SeriesTitle = "Vertigo Winters Edge", IssueNumber = "3", Description = "Vertigo Winters Edge #3" });
      issues.AddRange(ComicBuilder.GenerateRun( seriesIdPrefix: "100-bullets", seriesTitle: "100 Bullets", startIssue: 1, endIssue: 100, startYear: 1999, startMonth: 5 ));
      issues.AddRange(ComicBuilder.GenerateRun( seriesIdPrefix: "preacher", seriesTitle: "Preacher", startIssue: 1, endIssue: 66, startYear: 1999, startMonth: 4 ));
      ...
      issues.Add(new ComicIssue { IssueID = "young-avengers-presents-6", SeriesTitle = "Young Avengers Presents", IssueNumber = "6", PublishYear = 2012, Description = "Young Avengers Presents #6" });
      ...
      issues.Add(new ComicIssue { IssueID = "new-avengers-2013-34", SeriesTitle = "New Avengers (2013)", IssueNumber = "34", PublishYear = 2014, Description = "New Avengers (2013) #34" });
      issues.Add(new ComicIssue { IssueID = "new-avengers-2013-35", SeriesTitle = "New Avengers (2013)", IssueNumber = "35", PublishYear = 2014, Description = "New Avengers (2013) #35" });
      ...
      issues.Add(new ComicIssue { IssueID = "secret-wars-2015-10", SeriesTitle = "Secret Wars (2015)", IssueNumber = "10", PublishYear = 2015, Description = "Secret Wars (2015) #10" });
      issues.Add(new ComicIssue { IssueID = "secret-wars-2015-11", SeriesTitle = "Secret Wars (2015)", IssueNumber = "11", PublishYear = 2015, Description = "Secret Wars (2015) #11" });
      issues.Add(new ComicIssue { IssueID = "secret-wars-2015-12", SeriesTitle = "Secret Wars (2015)", IssueNumber = "12", PublishYear = 2015, Description = "Secret Wars (2015) #12" });
      ...
      issues.Add(new ComicIssue { IssueID = "all-new-x-men-2012-11", SeriesTitle = "All-New X-Men (2012)", IssueNumber = "11", PublishYear = 2012, Description = "All-New X-Men (2012) #11" });
      issues.Add(new ComicIssue { IssueID = "all-new-x-men-2012-12", SeriesTitle = "All-New X-Men (2012)", IssueNumber = "12", PublishYear = 2012, Description = "All-New X-Men (2012) #12" });
      ...
      issues.Add(new ComicIssue { IssueID = "winter-soldier-winter-kills-2", SeriesTitle = "Winter Soldier: Winter Kills", IssueNumber = "2", PublishYear = 2006, Description = "Winter Soldier: Winter Kills #2" });
      issues.Add(new ComicIssue { IssueID = "winter-soldier-winter-kills-3", SeriesTitle = "Winter Soldier: Winter Kills", IssueNumber = "3", PublishYear = 2006, Description = "Winter Soldier: Winter Kills #3" });
      ...
      issues.Add(new ComicIssue { IssueID = "uncanny-x-men-129", SeriesTitle = "Uncanny X-Men", IssueNumber = "129", PublishMonth = 12, PublishYear = 1979, Description = "By Friends - Betrayed!" });
      ...
      issues.Add(new ComicIssue { IssueID = "fantastic-four-36", SeriesTitle = "Fantastic Four", IssueNumber = "36", PublishYear = 1962 });
      ...
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-259", SeriesTitle = "Amazing Spider-Man", IssueNumber = "259", PublishMonth = 12, PublishYear = 1984 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-260", SeriesTitle = "Amazing Spider-Man", IssueNumber = "260", PublishMonth = 1, PublishYear = 1985 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-261", SeriesTitle = "Amazing Spider-Man", IssueNumber = "261", PublishMonth = 2, PublishYear = 1985 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-262", SeriesTitle = "Amazing Spider-Man", IssueNumber = "262", PublishMonth = 3, PublishYear = 1985 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-293", SeriesTitle = "Amazing Spider-Man", IssueNumber = "293", PublishMonth = 10, PublishYear = 1987 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-294", SeriesTitle = "Amazing Spider-Man", IssueNumber = "294", PublishMonth = 11, PublishYear = 1987 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-295", SeriesTitle = "Amazing Spider-Man", IssueNumber = "295", PublishMonth = 12, PublishYear = 1987 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-296", SeriesTitle = "Amazing Spider-Man", IssueNumber = "296", PublishMonth = 1, PublishYear = 1988 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-297", SeriesTitle = "Amazing Spider-Man", IssueNumber = "297", PublishMonth = 2, PublishYear = 1988 });
      ...
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-315", SeriesTitle = "Amazing Spider-Man", IssueNumber = "315", PublishMonth = 5, PublishYear = 1989, Description = "The Alien Costume Saga" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-316", SeriesTitle = "Amazing Spider-Man", IssueNumber = "316", PublishMonth = 6, PublishYear = 1989, Description = "The Alien Costume Saga" });
      ...
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-326", SeriesTitle = "Amazing Spider-Man", IssueNumber = "326", PublishMonth = 3, PublishYear = 1990 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-327", SeriesTitle = "Amazing Spider-Man", IssueNumber = "327", PublishMonth = 4, PublishYear = 1990 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-328", SeriesTitle = "Amazing Spider-Man", IssueNumber = "328", PublishMonth = 5, PublishYear = 1990 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-329", SeriesTitle = "Amazing Spider-Man", IssueNumber = "329", PublishMonth = 6, PublishYear = 1990 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-330", SeriesTitle = "Amazing Spider-Man", IssueNumber = "330", PublishMonth = 7, PublishYear = 1990 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-331", SeriesTitle = "Amazing Spider-Man", IssueNumber = "331", PublishMonth = 8, PublishYear = 1990 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-332", SeriesTitle = "Amazing Spider-Man", IssueNumber = "332", PublishMonth = 9, PublishYear = 1990 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-333", SeriesTitle = "Amazing Spider-Man", IssueNumber = "333", PublishMonth = 10, PublishYear = 1990 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-334", SeriesTitle = "Amazing Spider-Man", IssueNumber = "334", PublishMonth = 11, PublishYear = 1990 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-335", SeriesTitle = "Amazing Spider-Man", IssueNumber = "335", PublishMonth = 12, PublishYear = 1990 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-336", SeriesTitle = "Amazing Spider-Man", IssueNumber = "336", PublishMonth = 1, PublishYear = 1991 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-337", SeriesTitle = "Amazing Spider-Man", IssueNumber = "337", PublishMonth = 2, PublishYear = 1991 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-338", SeriesTitle = "Amazing Spider-Man", IssueNumber = "338", PublishMonth = 3, PublishYear = 1991 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-339", SeriesTitle = "Amazing Spider-Man", IssueNumber = "339", PublishMonth = 4, PublishYear = 1991 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-340", SeriesTitle = "Amazing Spider-Man", IssueNumber = "340", PublishMonth = 5, PublishYear = 1991 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-341", SeriesTitle = "Amazing Spider-Man", IssueNumber = "341", PublishMonth = 6, PublishYear = 1991 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-342", SeriesTitle = "Amazing Spider-Man", IssueNumber = "342", PublishMonth = 7, PublishYear = 1991 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-343", SeriesTitle = "Amazing Spider-Man", IssueNumber = "343", PublishMonth = 8, PublishYear = 1991 });
      ...
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-346", SeriesTitle = "Amazing Spider-Man", IssueNumber = "346", PublishMonth = 9, PublishYear = 1991 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-347", SeriesTitle = "Amazing Spider-Man", IssueNumber = "347", PublishMonth = 10, PublishYear = 1991 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-348", SeriesTitle = "Amazing Spider-Man", IssueNumber = "348", PublishMonth = 11, PublishYear = 1991 });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-349", SeriesTitle = "Amazing Spider-Man", IssueNumber = "349", PublishMonth = 12, PublishYear = 1991 });
      ...
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-364", SeriesTitle = "Amazing Spider-Man", IssueNumber = "364", PublishMonth = 7, PublishYear = 1992, Description = "Savage Grace!" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-365", SeriesTitle = "Amazing Spider-Man", IssueNumber = "365", PublishMonth = 8, PublishYear = 1992, Description = "Savage Grace!" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-366", SeriesTitle = "Amazing Spider-Man", IssueNumber = "366", PublishMonth = 9, PublishYear = 1992, Description = "Savage Grace!" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-367", SeriesTitle = "Amazing Spider-Man", IssueNumber = "367", PublishMonth = 10, PublishYear = 1992, Description = "Savage Grace!" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-368", SeriesTitle = "Amazing Spider-Man", IssueNumber = "368", PublishMonth = 11, PublishYear = 1992, Description = "Invasion of the Spider-Slayers" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-369", SeriesTitle = "Amazing Spider-Man", IssueNumber = "369", PublishMonth = 12, PublishYear = 1992, Description = "Invasion of the Spider-Slayers" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-370", SeriesTitle = "Amazing Spider-Man", IssueNumber = "370", PublishMonth = 1, PublishYear = 1993, Description = "Invasion of the Spider-Slayers" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-371", SeriesTitle = "Amazing Spider-Man", IssueNumber = "371", PublishMonth = 2, PublishYear = 1993, Description = "Invasion of the Spider-Slayers" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-372", SeriesTitle = "Amazing Spider-Man", IssueNumber = "372", PublishMonth = 3, PublishYear = 1993, Description = "Invasion of the Spider-Slayers" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-373", SeriesTitle = "Amazing Spider-Man", IssueNumber = "373", PublishMonth = 4, PublishYear = 1993, Description = "Invasion of the Spider-Slayers" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-374", SeriesTitle = "Amazing Spider-Man", IssueNumber = "374", PublishMonth = 5, PublishYear = 1993, Description = "Invasion of the Spider-Slayers" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-375", SeriesTitle = "Amazing Spider-Man", IssueNumber = "375", PublishMonth = 6, PublishYear = 1993, Description = "Invasion of the Spider-Slayers" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-376", SeriesTitle = "Amazing Spider-Man", IssueNumber = "376", PublishMonth = 7, PublishYear = 1993, Description = "Invasion of the Spider-Slayers" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-377", SeriesTitle = "Amazing Spider-Man", IssueNumber = "377", PublishMonth = 8, PublishYear = 1993, Description = "Invasion of the Spider-Slayers" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-378", SeriesTitle = "Amazing Spider-Man", IssueNumber = "378", PublishMonth = 9, PublishYear = 1993, Description = "Maximum Carnage Part 3" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-379", SeriesTitle = "Amazing Spider-Man", IssueNumber = "379", PublishMonth = 10, PublishYear = 1993, Description = "Maximum Carnage Part 7" });
      issues.Add(new ComicIssue { IssueID = "amazing-spider-man-380", SeriesTitle = "Amazing Spider-Man", IssueNumber = "380", PublishMonth = 11, PublishYear = 1993, Description = "Maximum Carnage Part 11" });
      ...
      issues.Add(new ComicIssue { IssueID = "spectacular-spider-man-annual-8", SeriesTitle = "Spectacular Spider-Man Annual Special", IssueNumber = "8" });
      ...
      issues.AddRange(ComicBuilder.GenerateRun(
        seriesIdPrefix: "vision-2015",
        seriesTitle: "Vision (2015)",
        startIssue: 0,
        endIssue: 12,
        startYear: 2015,
        startMonth: 1,
    ...
    public static StoryArc[] GetStoryArcs() {
      return new StoryArc[] {
        ...
        new StoryArc { ArcID = "arc-batman-and-son", Title = "Batman and Son", IssueIDs = new List<string> { "batman-655", "batman-656", "batman-657", "batman-658", "batman-663", "batman-664", "batman-665" } },
        ...
        new StoryArc { ArcID = "arc-batman-under-the-red-hood", Title = "Batman: Under the Red Hood", IssueIDs = new List<string> { "batman-635", "batman-636", "batman-637", "batman-638", "batman-639", "batman-640", "batman-641", "batman-645", "batman-646", "batman-647", "batman-648", "batman-649", "batman-650", "annual-batman-25" } },
        ...
        new StoryArc { ArcID = "arc-superman-batman-public-enemies", Title = "Superman/Batman", Description ="Written by Jeph Loeb, illustrated by Ed McGuinness", IssueIDs = new List<string> { "superman-batman-1", "superman-batman-2", "superman-batman-3", "superman-batman-4", "superman-batman-5", "superman-batman-6" } },
        new StoryArc { ArcID = "arc-superman-batman-the-supergirl-from-krypton", Title = "Superman/Batman", Description ="Written by Jeph Loeb, illustrated by Michael Turner", IssueIDs = new List<string> { "superman-batman-8", "superman-batman-9", "superman-batman-10", "superman-batman-11", "superman-batman-12", "superman-batman-13"} },
        new StoryArc { ArcID = "arc-superman-birthright", Title = "Superman: Birthright", IssueIDs = new List<string> { "superman-birthright-1", "superman-birthright-2", "superman-birthright-3", "superman-birthright-4", "superman-birthright-5", "superman-birthright-6", "superman-birthright-7", "superman-birthright-8", "superman-birthright-9", "superman-birthright-10", "superman-birthright-11", "superman-birthright-12" } },
        ...
        // Marvel Comics
        new StoryArc { ArcID = "arc-all-new-x-men-yesterday-s-x-men", Title = "All-New X-Men: Yesterday's X-Men", IssueIDs = new List<string> { "all-new-x-men-2012-1", "all-new-x-men-2012-2", "all-new-x-men-2012-3", "all-new-x-men-2012-4", "all-new-x-men-2012-5", "all-new-x-men-2012-6", "all-new-x-men-2012-7", "all-new-x-men-2012-8", "all-new-x-men-2012-9", "all-new-x-men-2012-10" } },
        new StoryArc { ArcID = "arc-avengers-time-runs-out", Title = "Avengers: Time Runs Out", IssueIDs = new List<string> { "avengers-2012-35", "avengers-2012-36", "avengers-2012-37", "avengers-2012-38", "avengers-2012-39", "avengers-2012-40", "avengers-2012-41", "avengers-2012-42", "avengers-2012-43", "avengers-2012-44", "new-avengers-2013-24", "new-avengers-2013-25", "new-avengers-2013-26", "new-avengers-2013-27", "new-avengers-2013-28", "new-avengers-2013-29", "new-avengers-2013-30", "new-avengers-2013-31", "new-avengers-2013-32", "new-avengers-2013-33", "new-avengers-2013-34", "new-avengers-2013-35" } },
        new StoryArc { ArcID = "arc-black-panther-a-nation-under-our-feet", Title = "Black Panther: A Nation Under Our Feet", IssueIDs = new List<string> { "black-panther-volume-5-1", "black-panther-volume-5-2", "black-panther-volume-5-3", "black-panther-volume-5-4", "black-panther-volume-5-5", "black-panther-volume-5-6", "black-panther-volume-5-7", "black-panther-volume-5-8", "black-panther-volume-5-9", "black-panther-volume-5-10", "black-panther-volume-5-11", "black-panther-volume-5-12" } },
        new StoryArc { ArcID = "arc-captain-america-the-death-of-captain-america", Title = "Captain America: The Death of Captain America", IssueIDs = new List<string> { "captain-america-2004-22", "captain-america-2004-23", "captain-america-2004-24", "captain-america-2004-25", "captain-america-2004-26", "captain-america-2004-27", "captain-america-2004-28", "captain-america-2004-29", "captain-america-2004-30", "winter-soldier-winter-kills-1", "winter-soldier-winter-kills-2", "winter-soldier-winter-kills-3" } },
        new StoryArc { ArcID = "arc-captain-america-the-winter-soldier", Title = "Captain America: The Winter Soldier", IssueIDs = new List<string> { "captain-america-volume-5-1", "captain-america-volume-5-2", "captain-america-volume-5-3", "captain-america-volume-5-4", "captain-america-volume-5-5", "captain-america-volume-5-6", "captain-america-volume-5-7", "captain-america-volume-5-8", "captain-america-volume-5-9", "captain-america-volume-5-10", "captain-america-volume-5-11", "captain-america-volume-5-12" } },
        new StoryArc { ArcID = "arc-civil-war", Title = "Civil War", IssueIDs = new List<string> { "civil-war-1", "civil-war-2", "civil-war-3", "civil-war-4", "civil-war-5", "civil-war-6", "civil-war-7" } },
        new StoryArc { ArcID = "arc-daredevil-born-again", Title = "Daredevil: Born Again", IssueIDs = new List<string> { "daredevil-volume-1-226", "daredevil-volume-1-227", "daredevil-volume-1-228", "daredevil-volume-1-229", "daredevil-volume-1-230", "daredevil-volume-1-231", "daredevil-volume-1-232", "daredevil-volume-1-233" } },
        new StoryArc { ArcID = "arc-fantastic-four-solve-everything", Title = "Fantastic Four: Solve Everything", IssueIDs = new List<string> { "fantastic-four-570", "fantastic-four-571", "fantastic-four-572", "fantastic-four-573", "fantastic-four-574", "fantastic-four-575", "fantastic-four-576", "fantastic-four-577", "fantastic-four-578", "fantastic-four-579", "fantastic-four-580", "fantastic-four-581", "fantastic-four-582", "fantastic-four-583", "fantastic-four-584", "fantastic-four-585", "fantastic-four-586", "fantastic-four-587", "fantastic-four-588" } },
        ...
        new StoryArc { ArcID = "arc-wolverine-old-man-logan", Title = "Wolverine: Old Man Logan", IssueIDs = new List<string> { "wolverine-volume-3-66", "wolverine-volume-3-67", "wolverine-volume-3-68", "wolverine-volume-3-69", "wolverine-volume-3-70", "wolverine-volume-3-71", "wolverine-volume-3-72", "wolverine-old-man-logan-giant-size-1" } },
        ...
        new StoryArc { ArcID = "arc-x-men-bishop-to-king's-five", Title = "X-Men: Bishop to King's Five!", Description = "By Lee, Scott Lobdell and Romita Jr.", IssueIDs = new List<string> { "uncanny-x-men-287" } },
        new StoryArc { ArcID = "arc-x-men-busting-loose", Title = "X-Men: Busting Loose", Description = "By Chris Claremont", IssueIDs = new List<string> { "uncanny-x-men-236"} },
        new StoryArc { ArcID = "arc-x-men-by-friends-betrayed", Title = "X-Men: By Friends - Betrayed!", Description = "By Chris Claremont and Michael Golden and Armando Gil", IssueIDs = new List<string> { "avengers-annual-10" } },
        new StoryArc { ArcID = "arc-x-men-catacombs", Title = "X-Men: Catacombs", Description = "By Chris Claremont and Paul Smith", IssueIDs = new List<string> { "uncanny-x-men-169"} },
        new StoryArc { ArcID = "arc-x-men-come-the-apocalypse", Title = "X-Men: Come the Apocalypse", Description = "By Louise Simonson and Walter Simonson and Marc Silvestri", IssueIDs = new List<string> { "x-factor-10", "x-factor-12", "x-factor-15", "x-factor-19", "x-factor-24" } },
        new StoryArc { ArcID = "arc-x-men-dancin-in-the-dark", Title = "X-Men: Dancin' in the Dark", Description = "By Chris Claremont and Paul Smith", IssueIDs = new List<string> { "uncanny-x-men-170"} },
        new StoryArc { ArcID = "arc-x-men-dark-shroud-of-the-past", Title = "X-Men: Dark Shroud of the Past", Description = "By Chris Claremont and Bill Mantlo and Dave Cockrum and William Robert Brown", IssueIDs = new List<string> { "x-men-106" } },
        new StoryArc { ArcID = "arc-x-men-days-of-future-past", Title = "X-Men: Days of Future Past", Description = "By Chris Claremont and John Byrne", IssueIDs = new List<string> { "uncanny-x-men-141"} },
        new StoryArc { ArcID = "arc-x-men-deadly-genesis", Title = "X-Men: Deadly Genesis", Description = "By Len Wein and Dave Cockrum", IssueIDs = new List<string> { "giant-size-x-men-1"} },
        new StoryArc { ArcID = "arc-x-men-deathstar-rising", Title = "X-Men: Deathstar Rising", Description = "By Chris Claremont and Dave Cockrum", IssueIDs = new List<string> { "x-men-99" } },
        new StoryArc { ArcID = "arc-x-men-elegy", Title = "X-Men: Elegy", Description = "Kitty Pryde's first appearance. By Chris Claremont and John Byrne", IssueIDs = new List<string> { "uncanny-x-men-138"} },
        new StoryArc { ArcID = "arc-x-men-enter-magneto", Title = "X-Men: Enter Magneto", Description = "By Stan Lee and Jack Kirby", IssueIDs = new List<string> { "x-men-1"} },
        new StoryArc { ArcID = "arc-x-men-fallout", Title = "X-Men: Fallout!", Description = "By Chris Claremont and Jim Lee and Scott Williams", IssueIDs = new List<string> { "x-men-volume-2-3" } },
        new StoryArc { ArcID = "arc-x-men-fatal-attractions", Title = "X-Men: Fatal Attractions", Description = "Crossover storyline" },
        new StoryArc { ArcID = "arc-x-men-firestorm", Title = "X-Men: Firestorm", Description = "By Chris Claremont and Jim Lee and Scott Williams", IssueIDs = new List<string> { "x-men-volume-2-2" } },
        new StoryArc { ArcID = "arc-x-men-first-blood", Title = "X-Men: First Blood", Description = "By Chris Claremont and John Byrne and Terry Austin", IssueIDs = new List<string> { "uncanny-x-men-155" } },
        new StoryArc { ArcID = "arc-x-men-gonna-be-a-revolution", Title = "X-Men: Gonna be a Revolution", Description = "By Chris Claremont", IssueIDs = new List<string> { "uncanny-x-men-238"} },
        new StoryArc { ArcID = "arc-x-men-greater-love-hath-no-x-man", Title = "X-Men: Greater Love Hath No X-Man", Description = "By Chris Claremont and Dave Cockrum", IssueIDs = new List<string> { "x-men-100" } },
        new StoryArc { ArcID = "arc-x-men-kitty's-fairy-tale", Title = "X-Men: Kitty's Fairy Tale", Description = "By Chris Claremontand Dave Cockrum", IssueIDs = new List<string> { "uncanny-x-men-153" } },
        new StoryArc { ArcID = "arc-x-men-ladies-night", Title = "X-Men: Ladies' Night", Description = "Jubilee's first appearance. By Chris Claremont and Marc Silvestri", IssueIDs = new List<string> { "uncanny-x-men-244"} },
        new StoryArc { ArcID = "arc-x-men-lifedeath-ii-from-the-heart-of-darkness", Title = "X-Men: Lifedeath II: From the Heart of Darkness", Description = "By Chris Claremont and Barry Windsor-Smith", IssueIDs = new List<string> { "uncanny-x-men-198" } },
        new StoryArc { ArcID = "arc-x-men-like-a-phoenix-from-the-ashes", Title = "X-Men: Like a Phoenix, from the Ashes", Description = "By Chris Claremont and Dave Cockrum", IssueIDs = new List<string> { "x-men-101" } },
        new StoryArc { ArcID = "arc-x-men-madripoor-knights", Title = "X-Men: Madripoor Knights", Description = "By Chris Claremont and Jim Lee and Scott Williams", IssueIDs = new List<string> { "uncanny-x-men-268" } },
        new StoryArc { ArcID = "arc-x-men-mind-out-of-time", Title = "X-Men: Mind Out of Time", Description = "By Chris Claremont and John Byrne", IssueIDs = new List<string> { "uncanny-x-men-142"} },
        new StoryArc { ArcID = "arc-x-men-my-brother-my-enemy", Title = "X-Men: My Brother, My Enemy", Description = "By Chris Claremont and Dave Cockrum and Sam Grainger", IssueIDs = new List<string> { "x-men-97" } },
        new StoryArc { ArcID = "arc-x-men-nightmare-quest", Title = "X-Men: Nightmare Quest!", Description = "By Larry Hama and Mark Texeira", IssueIDs = new List<string> { "wolverine-61" } },
        new StoryArc { ArcID = "arc-x-men-orphans-end", Title = "X-Men: Orphan's End", Description = "By Chris Claremont and John Byrne and Terry Austin", IssueIDs = new List<string> { "uncanny-x-men-154", "uncanny-x-men-155" } },
        new StoryArc { ArcID = "arc-x-men-phoenix-unleashed", Title = "X-Men: Phoenix Unleashed", Description = "By Chris Claremont and Dave Cockrum", IssueIDs = new List<string> { "x-men-105" } },
        new StoryArc { ArcID = "arc-x-men-public-enemy", Title = "X-Men: Public Enemy", Description = "By Chris Claremont and John Romita Jr.", IssueIDs = new List<string> { "uncanny-x-men-185"} },
        new StoryArc { ArcID = "arc-x-men-raiders-of-the-lost-temple", Title = "X-Men: Raiders of the Lost Temple", Description = "By Chris Claremont and John Romita Jr.", IssueIDs = new List<string> { "uncanny-x-men-191" } },
        new StoryArc { ArcID = "arc-x-men-reunion", Title = "X-Men: Reunion!", Description = "", IssueIDs = new List<string> { "wolverine-62", "uncanny-x-men-154" } },
        new StoryArc { ArcID = "arc-x-men-rogue-redux", Title = "X-Men: Rogue Redux", Description = "By Chris Claremont and Jim Lee and Art Thibert", IssueIDs = new List<string> { "uncanny-x-men-269" } },
        new StoryArc { ArcID = "arc-x-men-rubicon", Title = "X-Men: Rubicon", Description = "By Chris Claremont and Jim Lee and Scott Williams", IssueIDs = new List<string> { "x-men-volume-2-1" } },
        new StoryArc { ArcID = "arc-x-men-sentinels", Title = "X-Men: Sentinels", Description = "By Chris Claremont", IssueIDs = new List<string> { "the-new-mutants-2"} },
        new StoryArc { ArcID = "arc-x-men-shoot-out-at-the-stampede", Title = "X-Men: Shoot-Out at the Stampede", Description = "By Chris Claremont and John Byrne and Terry Austin", IssueIDs = new List<string> { "uncanny-x-men-121" } },
        new StoryArc { ArcID = "arc-x-men-the-fall-of-the-tower", Title = "X-Men: The Fall of the Tower", Description = "By Chris Claremont and Dave Cockrum and Sam Grainger", IssueIDs = new List<string> { "x-men-103" } },
        new StoryArc { ArcID = "arc-x-men-the-final-decision", Title = "X-Men: The Final Decision", Description = "By Chris Claremont and John Byrne", IssueIDs = new List<string> { "x-men-14", "x-men-15", "x-men-16" } },
        new StoryArc { ArcID = "arc-x-men-the-gentleman's-name-is-magneto", Title = "X-Men: The Gentleman's Name is Magneto", Description = "By Chris Claremont and Dave Cockrum and Sam Grainger", IssueIDs = new List<string> { "x-men-104" } },
        new StoryArc { ArcID = "arc-x-men-the-juggernauts-back-in-town", Title = "X-Men: The Juggernaut's Back in Town", Description = "By Chris Claremont and John Romita Jr.", IssueIDs = new List<string> { "uncanny-x-men-194"} },
        new StoryArc { ArcID = "arc-x-men-the-origin-of-professor-x", Title = "X-Men: The Origin of Professor X", Description = "By Stan Lee and Jack Kirby and Alex Toth", IssueIDs = new List<string> { "x-men-12"} },
        new StoryArc { ArcID = "arc-x-men-the-phalanx-covenant", Title = "X-Men: The Phalanx Covenant", Description = "By Chris Claremont and Jim Lee and Scott Williams", IssueIDs = new List<string> { "phalanx-covenant-1", "phalanx-covenant-2" } },
        new StoryArc { ArcID = "arc-x-men-the-shiva-scenario", Title = "X-Men: The Shiva Scenario", Description = "By Larry Hama and Marc Silvestri", IssueIDs = new List<string> { "wolverine-48", "wolverine-49", "wolverine-50" } },
        new StoryArc { ArcID = "arc-x-men-weapon-x", Title = "X-Men: Weapon X", Description = "By Chris Claremont and John Byrne and Terry Austin", IssueIDs = new List<string> { "marvel-comics-presents-72", "marvel-comics-presents-73", "marvel-comics-presents-74", "marvel-comics-presents-75", "marvel-comics-presents-76", "marvel-comics-presents-77", "marvel-comics-presents-78", "marvel-comics-presents-79", "marvel-comics-presents-80", "marvel-comics-presents-81", "marvel-comics-presents-82", "marvel-comics-presents-83", "marvel-comics-presents-84" } },
        new StoryArc { ArcID = "arc-x-men-welcome-to-genosha", Title = "X-Men: Welcome to Genosha", Description = "By Chris Claremont", IssueIDs = new List<string> { "uncanny-x-men-235"} },
        new StoryArc { ArcID = "arc-x-men-what-goes-around", Title = "X-Men: What Goes Around...", Description = "By Larry Hama and Mark Texeira", IssueIDs = new List<string> { "wolverine-64" } },
        new StoryArc { ArcID = "arc-x-men-where-no-x-man-has-gone-before", Title = "X-Men: Where No X-Man Has Gone Before", Description = "By Chris Claremont and Dave Cockrum and Dan Green", IssueIDs = new List<string> { "x-men-107" } },
        new StoryArc { ArcID = "arc-x-men-who's-human", Title = "X-Men: Who's Human?", Description = "By Chris Claremont", IssueIDs = new List<string> { "uncanny-x-men-237"} },
        new StoryArc { ArcID = "arc-x-men-who-will-stop-the-juggernaut", Title = "X-Men: Who Will Stop the Juggernaut?", Description = "By Chris Claremont and Dave Cockrum and Sam Grainger", IssueIDs = new List<string> { "x-men-102", "x-men-103", "x-men-104" } },
        new StoryArc { ArcID = "arc-x-men-x-ternally-yours", Title = "X-Men: X-Ternally Yours", Description = "By Howard Mackie and Lee Weeks and Klaus Janson", IssueIDs = new List<string> { "gambit-1", "gambit-2", "gambit-3", "gambit-4" } },

        new StoryArc { ArcID = "arc-spider-man-face-to-face-with-the-lizard", Title = "Spider-Man: Face-to-Face with the Lizard", IssueIDs = new List<string> { "amazing-spider-man-6" } },
        new StoryArc { ArcID = "arc-spider-man-captured-by-j-jonah-jameson", Title = "Spider-Man: Captured by J. Jonah Jameson!", IssueIDs = new List<string> { "amazing-spider-man-25" } },
        new StoryArc { ArcID = "arc-spider-man-marked-for-destruction-by-dr-doom", Title = "Spider-Man: Marked for Destruction by Dr. Doom!", IssueIDs = new List<string> { "amazing-spider-man-5" } },
        ...
        new StoryArc { ArcID = "arc-spider-man-kraven-the-hunter", Title = "Spider-Man: Kraven the Hunter", IssueIDs = new List<string> { "amazing-spider-man-15" } },
        new StoryArc { ArcID = "arc-spider-man-the-sinister-secret-of-spider-mans-new-costume", Title = "Spider-Man: The Sinister Secret of Spider-Man's New Costume!", IssueIDs = new List<string> { "amazing-spider-man-258" } },
        new StoryArc { ArcID = "arc-spider-man-chance-encounter", Title = "Spider-Man: Chance Encounter", IssueIDs = new List<string> { "amazing-spider-man-298" } },
        new StoryArc { ArcID = "arc-spider-man-the-sand-and-the-fury", Title = "Spider-Man: The Sand and the Fury", IssueIDs = new List<string> { "amazing-spider-man-317" } },
        new StoryArc { ArcID = "arc-spider-man-secrets", Title = "Spider-Man: Secrets!", IssueIDs = new List<string> { "amazing-spider-man-249" } },
        new StoryArc { ArcID = "arc-spider-man-confessions", Title = "Spider-Man: Confessions!", IssueIDs = new List<string> { "amazing-spider-man-250" } },
        ...
        new StoryArc { ArcID = "arc-spider-man-spider-man", Title = "Spider-Man: Spider-Man!", IssueIDs = new List<string> { "amazing-fantasy-15" } },
        new StoryArc { ArcID = "arc-spider-man-the-fiend-from-the-fire", Title = "Spider-Man: The Fiend from the Fire!", IssueIDs = new List<string> { "amazing-spider-man-172" } },
        new StoryArc { ArcID = "arc-spider-man-the-rocket-racers-back-in-town", Title = "Spider-Man: The Rocket Racer's Back in Town!", IssueIDs = new List<string> { "amazing-spider-man-182", "amazing-spider-man-183" } },
        new StoryArc { ArcID = "arc-spider-man-the-ultimate-slayer", Title = "Spider-Man: The Ultimate Slayer!", IssueIDs = new List<string> { "amazing-spider-man-373" } },
        new StoryArc { ArcID = "arc-spider-man-tombstone", Title = "Spider-Man: Tombstone!", IssueIDs = new List<string> { "spectacular-spider-man-139", "spectacular-spider-man-142" } },
        ...
        new StoryArc { ArcID = "arc-spider-man-the-spot", Title = "Spider-Man: The Spot!", IssueIDs = new List<string> { "spectacular-spider-man-98", "spectacular-spider-man-99" } },
        ...
        new StoryArc { ArcID = "arc-spider-man-the-return-of-the-green-goblin", Title = "Spider-Man: The Return of the Green Goblin!", IssueIDs = new List<string> { "amazing-spider-man-136", "amazing-spider-man-137" } },
        new StoryArc { ArcID = "arc-spider-man-six-forgotten-warriors", Title = "Spider-Man: Six Forgotten Warriors!", IssueIDs = new List<string> { "amazing-spider-man-annual-5", "amazing-spider-man-320", "amazing-spider-man-321", "amazing-spider-man-322", "amazing-spider-man-323", "amazing-spider-man-324", "amazing-spider-man-325" } },
        ...
        "giant-size-spider-man-5", "spectacular-spider-man-25", "spectacular-spider-man-26", "spectacular-spider-man-27", "spectacular-spider-man-28", "spectacular-spider-man-29", "spectacular-spider-man-30", "spectacular-spider-man-31", "spectacular-spider-man-149", "spectacular-spider-man-162", "spectacular-spider-man-163", "spectacular-spider-man-annual-8", "what-if-30"   } },
        ...
        "marvel-team-up-141", "marvel-team-up-142", "marvel-team-up-143", "marvel-team-up-144", "marvel-team-up-145", "marvel-team-up-146", "marvel-team-up-147", "marvel-team-up-148", "marvel-team-up-149", "marvel-team-up-150", "spectacular-spider-man-90", "spectacular-spider-man-91", "spectacular-spider-man-92", "spectacular-spider-man-93", "spectacular-spider-man-94", "spectacular-spider-man-95", "spectacular-spider-man-96", "spectacular-spider-man-97", "spectacular-spider-man-98", "spectacular-spider-man-99", "spectacular-spider-man-100", "web-of-spider-man-1" } },
        new StoryArc { ArcID = "arc-spider-man-the-death-of-jean-dewolff", Title = "Spider-Man: The Death of Jean DeWolff!", Description = "By Peter David and Rich Buckler", IssueIDs = new List<string> { "spectacular-spider-man-107", "spectacular-spider-man-108", "spectacular-spider-man-109", "spectacular-spider-man-110" } },
        ...
        new StoryArc { ArcID = "arc-spider-man-the-clone-saga", Title = "Spider-Man: The Clone Saga!", Description = "By Various", IssueIDs = new List<string> {} },
        ...
        new StoryArc { ArcID = "arc-spider-man-identity-crisis", Title = "Spider-Man: Identity Crisis!", Description = "By J. M. DeMatteis and Various", IssueIDs = new List<string> { "amazing-spider-man-434", "amazing-spider-man-435", "sensational-spider-man-27", "sensational-spider-man-28", "spectacular-spider-man-91", "spectacular-spider-man-92", "spectacular-spider-man-257", "spectacular-spider-man-258", "amazing-spider-man-440", "sensational-spider-man-32", "sensational-spider-man-33", "spectacular-spider-man-96", "spectacular-spider-man-262", "amazing-spider-man-441", "spectacular-spider-man-97", "spectacular-spider-man-263" } },
        new StoryArc { ArcID = "arc-spider-man-the-gathering-of-five", Title = "Spider-Man: The Gathering of Five!", Description = "By Todd Dezago and John Byrne and Howard Mackie", IssueIDs = new List<string> { "amazing-spider-man-440", "sensational-spider-man-32", "sensational-spider-man-33", "spectacular-spider-man-96", "spectacular-spider-man-262" } },
        new StoryArc { ArcID = "arc-spider-man-the-final-chapter", Title = "Spider-Man: The Final Chapter!", Description = "By Todd Dezago and John Byrne and Howard Mackie", IssueIDs = new List<string> { "amazing-spider-man-441", "spectacular-spider-man-97", "spectacular-spider-man-263" } },
        new StoryArc { ArcID = "arc-spider-man-flowers-for-rhino", Title = "Spider-Man: Flowers for Rhino!", Description = "By Peter Milligan and Various", IssueIDs = new List<string> { "spider-man-s-tangled-web-5", "spider-man-s-tangled-web-6" } },
        new StoryArc { ArcID = "arc-spider-man-the-book-of-ezekiel", Title = "Spider-Man: The Book of Ezekiel!", Description = "By J. Michael Straczynski and Various", IssueIDs = new List<string> { "amazing-spider-man-503", "amazing-spider-man-504", "amazing-spider-man-505", "amazing-spider-man-506", "amazing-spider-man-507", "amazing-spider-man-508" } },
        new StoryArc { ArcID = "arc-spider-man-the-other", Title = "Spider-Man: The Other!", Description = "By Various", IssueIDs = new List<string> { "friendly-neighborhood-spider-man-1", "friendly-neighborhood-spider-man-2", "friendly-neighborhood-spider-man-3", "friendly-neighborhood-spider-man-4" } },
        new StoryArc { ArcID = "arc-spider-man-civil-war", Title = "Spider-Man: Civil War!", Description = "By J. Michael Straczynski and Various", IssueIDs = new List<string> { "amazing-spider-man-529", "amazing-spider-man-530", "amazing-spider-man-531", "amazing-spider-man-532", "amazing-spider-man-533", "amazing-spider-man-534", "amazing-spider-man-535", "amazing-spider-man-536", "amazing-spider-man-537", "amazing-spider-man-538" } },
        new StoryArc { ArcID = "arc-spider-man-back-in-black", Title = "Spider-Man: Back in Black!", Description = "By J. Michael Straczynski and Various", IssueIDs = new List<string> { "amazing-spider-man-539", "amazing-spider-man-540", "amazing-spider-man-541", "amazing-spider-man-542", "amazing-spider-man-543" } },
        new StoryArc { ArcID = "arc-spider-man-one-more-day", Title = "Spider-Man: One More Day!", Description = "By J. Michael Straczynski and Various", IssueIDs = new List<string> { "amazing-spider-man-544", "amazing-spider-man-545" } },
        new StoryArc { ArcID = "arc-spider-man-brand-new-day", Title = "Spider-Man: Brand New Day!", Description = "By Dan Slott and Various", IssueIDs = new List<string> { "amazing-spider-man-546", "amazing-spider-man-547", "amazing-spider-man-548", "amazing-spider-man-549", "amazing-spider-man-550", "amazing-spider-man-551", "amazing-spider-man-552", "amazing-spider-man-553", "amazing-spider-man-554", "amazing-spider-man-555", "amazing-spider-man-556", "amazing-spider-man-557", "amazing-spider-man-558", "amazing-spider-man-559", "amazing-spider-man-560", "amazing-spider-man-561", "amazing-spider-man-562", "amazing-spider-man-563", "amazing-spider-man-564" } },
        new StoryArc { ArcID = "arc-spider-man-kravens-first-hunt", Title = "Spider-Man: Kraven's First Hunt!", Description = "By Marc Guggenheim and Various", IssueIDs = new List<string> { "amazing-spider-man-565", "amazing-spider-man-566", "amazing-spider-man-567" } },
        new StoryArc { ArcID = "arc-spider-man-new-ways-to-die", Title = "Spider-Man: New Ways to Die!", Description = "By Dan Slott and Various", IssueIDs = new List<string> { "amazing-spider-man-568", "amazing-spider-man-569", "amazing-spider-man-570", "amazing-spider-man-571", "amazing-spider-man-572", "amazing-spider-man-573" } },
        new StoryArc { ArcID = "arc-spider-man-spidey-meets-the-president", Title = "Spider-Man: Spidey Meets the President!", Description = "By Zeb Wells and Various", IssueIDs = new List<string> { "amazing-spider-man-583" } },
        new StoryArc { ArcID = "arc-spider-man-died-in-your-arms-tonight", Title = "Spider-Man: Died in Your Arms Tonight!", Description = "By Various and Various", IssueIDs = new List<string> { "amazing-spider-man-600", "amazing-spider-man-601" } },
        new StoryArc { ArcID = "arc-spider-man-red-headed-stranger", Title = "Spider-Man: Red-Headed Stranger!", Description = "By Various and Various", IssueIDs = new List<string> { "amazing-spider-man-602", "amazing-spider-man-603", "amazing-spider-man-604", "amazing-spider-man-605" } },
        new StoryArc { ArcID = "arc-spider-man-return-of-the-black-cat", Title = "Spider-Man: Return of the Black Cat!", Description = "By Joe Kelly and Various", IssueIDs = new List<string> { "amazing-spider-man-606", "amazing-spider-man-607", "amazing-spider-man-608", "amazing-spider-man-609", "amazing-spider-man-610", "amazing-spider-man-611" } },
        new StoryArc { ArcID = "arc-spider-man-the-gauntlet", Title = "Spider-Man: The Gauntlet!", Description = "By Various and Various", IssueIDs = new List<string> { "amazing-spider-man-612", "amazing-spider-man-613", "amazing-spider-man-614", "amazing-spider-man-615", "amazing-spider-man-616", "amazing-spider-man-617", "amazing-spider-man-618", "amazing-spider-man-619", "amazing-spider-man-620", "amazing-spider-man-621", "amazing-spider-man-622", "amazing-spider-man-623", "amazing-spider-man-624", "amazing-spider-man-625", "amazing-spider-man-626", "amazing-spider-man-627", "amazing-spider-man-628", "amazing-spider-man-629", "amazing-spider-man-630", "amazing-spider-man-631", "amazing-spider-man-632", "amazing-spider-man-633" } },
        new StoryArc { ArcID = "arc-spider-man-grim-hunt", Title = "Spider-Man: Grim Hunt!", Description = "By Various and Various", IssueIDs = new List<string> { "amazing-spider-man-634", "amazing-spider-man-635", "amazing-spider-man-636", "amazing-spider-man-637" } },
        new StoryArc { ArcID = "arc-spider-man-one-moment-in-time", Title = "Spider-Man: One Moment in Time!", Description = "By Various and Various", IssueIDs = new List<string> { "amazing-spider-man-638", "amazing-spider-man-639", "amazing-spider-man-640", "amazing-spider-man-641" } },
        new StoryArc { ArcID = "arc-spider-man-origin-of-the-species", Title = "Spider-Man: Origin of the Species!", Description = "By Various and Various", IssueIDs = new List<string> { "amazing-spider-man-642", "amazing-spider-man-643", "amazing-spider-man-644", "amazing-spider-man-645", "amazing-spider-man-646", "amazing-spider-man-647" } },
        new StoryArc { ArcID = "arc-spider-man-big-time", Title = "Spider-Man: Big Time!", Description = "By Dan Slott and Various", IssueIDs = new List<string> { "amazing-spider-man-648", "amazing-spider-man-649", "amazing-spider-man-650", "amazing-spider-man-651", "amazing-spider-man-652", "amazing-spider-man-653", "amazing-spider-man-654", "amazing-spider-man-655", "amazing-spider-man-656" } },
        new StoryArc { ArcID = "arc-spider-man-spider-island", Title = "Spider-Man: Spider-Island!", Description = "By Dan Slott and Stefano Caselli", IssueIDs = new List<string> { "amazing-spider-man-666", "amazing-spider-man-667", "amazing-spider-man-668", "amazing-spider-man-669", "amazing-spider-man-670", "amazing-spider-man-671", "amazing-spider-man-672", "amazing-spider-man-673", "venom-2-6", "venom-2-7", "venom-2-8" } },
        new StoryArc { ArcID = "arc-spider-man-ends-of-the-earth", Title = "Spider-Man: Ends of the Earth!", Description = "By Dan Slott and Stefano Caselli", IssueIDs = new List<string> { "amazing-spider-man-682", "amazing-spider-man-683", "amazing-spider-man-684", "amazing-spider-man-685", "amazing-spider-man-686", "amazing-spider-man-687", "avenging-spider-man-8" } },
        new StoryArc { ArcID = "arc-spider-man-dying-wish", Title = "Spider-Man: Dying Wish!", Description = "By Various and Various", IssueIDs = new List<string> { "amazing-spider-man-698", "amazing-spider-man-699", "amazing-spider-man-700" } },
        new StoryArc { ArcID = "arc-spider-man-family-business", Title = "Spider-Man: Family Business!", Description = "By Various and Various", IssueIDs = new List<string> { "amazing-spider-man-family-business" } },
        new StoryArc { ArcID = "arc-spider-man-spider-verse", Title = "Spider-Man: Spider-Verse!", Description = "By Various and Various" },
        new StoryArc { ArcID = "arc-spider-man-dead-no-more-the-clone-conspiracy", Title = "Spider-Man: Dead No More: The Clone Conspiracy!", Description = "By Dan Slott and Jim Cheung", IssueIDs = new List<string> { "amazing-spider-man-19", "amazing-spider-man-20", "amazing-spider-man-21", "amazing-spider-man-22", "amazing-spider-man-23", "amazing-spider-man-24" } },
        new StoryArc { ArcID = "arc-spider-man-go-down-swinging", Title = "Spider-Man: Go Down Swinging!", Description = "By Dan Slott and Nick Brashaw", IssueIDs = new List<string> { "amazing-spider-man-797", "amazing-spider-man-798", "amazing-spider-man-799", "amazing-spider-man-800" } },
        new StoryArc { ArcID = "arc-spider-man-spidergeddon", Title = "Spider-Man: Spidergeddon!", Description = "By Dan Slott and Various" },
        new StoryArc { ArcID = "arc-spider-man-hunted", Title = "Spider-Man: Hunted!", Description = "By Nick Spencer and Various", IssueIDs = new List<string> { "amazing-spider-man-16", "amazing-spider-man-17", "amazing-spider-man-18" } },
        new StoryArc { ArcID = "arc-spider-man-absolute-carnage", Title = "Spider-Man: Absolute Carnage!", Description = "By Donny Cates and Various" },
        new StoryArc { ArcID = "arc-spider-man-sins-rising", Title = "Spider-Man: Sins Rising!" },
        new StoryArc { ArcID = "arc-spider-man-last-remains", Title = "Spider-Man: Last Remains!" },
        new StoryArc { ArcID = "arc-spider-man-sinister-war", Title = "Spider-Man: Sinister War!" },
        new StoryArc { ArcID = "arc-spider-man-dark-web", Title = "Spider-Man: Dark Web!" },
        new StoryArc { ArcID = "arc-spider-man-end-of-the-spider-verse", Title = "Spider-Man: End of the Spider-Verse!" },
        new StoryArc { ArcID = "arc-spider-man-contest-of-chaos", Title = "Spider-Man: Contest of Chaos!" },
        new StoryArc { ArcID = "arc-spider-man-gang-war", Title = "Spider-Man: Gang War!" },
        new StoryArc { ArcID = "arc-spider-man-eight-deaths-of-spider-man", Title = "Spider-Man: Eight Deaths of Spider-Man!" },

 
        new StoryArc { ArcID = "arc-fantastic-four-the-origin-of-fantastic-four", Title = "The Origin of the Fantastic Four", IssueIDs = new List<string> { "fantastic-four-1", "fantastic-four-8" } },
        new StoryArc { ArcID = "arc-fantastic-four-now-comes-the-sub-mariner", Title = "Now Comes the Sub-Mariner", IssueIDs = new List<string> { "fantastic-four-4" } },
        new StoryArc { ArcID = "arc-fantastic-four-incursion-of-the-skrulls", Title = "Incursion of the Skrulls", IssueIDs = new List<string> { "fantastic-four-2" } },
        new StoryArc { ArcID = "arc-fantastic-four-the-silver-surfer-and-the-coming-of-galactus", Title = "The Silver Surfer and the Coming of Galactus", IssueIDs = new List<string> { "fantastic-four-48", "fantastic-four-50" } },
        new StoryArc { ArcID = "arc-fantastic-four-super-skrull", Title = "Super Skrull", IssueIDs = new List<string> { "fantastic-four-18" } },
        new StoryArc { ArcID = "arc-fantastic-four-the-mask-of-doom-part-i", Title = "The Mask of Doom, Part I", IssueIDs = new List<string> { "fantastic-four-5" } },
        new StoryArc { ArcID = "arc-fantastic-four-the-mask-of-doom-part-ii", Title = "The Mask of Doom, Part II", IssueIDs = new List<string> { "fantastic-four-5", "fantastic-four-annual-2" } },
        new StoryArc { ArcID = "arc-fantastic-four-the-mask-of-doom-part-iii", Title = "The Mask of Doom, Part III", IssueIDs = new List<string> { "fantastic-four-5" } },
        new StoryArc { ArcID = "arc-fantastic-four-mole-man", Title = "Mole Man", IssueIDs = new List<string> { "fantastic-four-1" } },
        new StoryArc { ArcID = "arc-fantastic-four-behold-the-negative-zone", Title = "Behold the Negative Zone", IssueIDs = new List<string> { "fantastic-four-1" } },
        new StoryArc { ArcID = "arc-fantastic-four-the-silver-surfer-and-the-return-of-galactus", Title = "The Silver Surfer and the Return of Galactus", IssueIDs = new List<string> { "fantastic-four-57", "fantastic-four-60" } },
        new StoryArc { ArcID = "arc-fantastic-four-and-a-blind-man-shall-lead-them", Title = "And a Blind Man Shall Lead Them", IssueIDs = new List<string> { "fantastic-four-39", "fantastic-four-40" } },
        new StoryArc { ArcID = "arc-fantastic-four-inhumans-saga-part-1-and-the-wind-cryes-medusa", Title = "Inhumans Saga, Part 1: And the Wind Cries Medusa", IssueIDs = new List<string> { "fantastic-four-36", "fantastic-four-41", "fantastic-four-42", "fantastic-four-43", "fantastic-four-44", "fantastic-four-45", "fantastic-four-46", "fantastic-four-47" } },
        new StoryArc { ArcID = "arc-fantastic-four-inhumans-saga-part-2-the-inhumans-among-us", Title = "Inhumans Saga, Part 2: The Inhumans Among Us", IssueIDs = new List<string> { "fantastic-four-36", "fantastic-four-41", "fantastic-four-42", "fantastic-four-43", "fantastic-four-44", "fantastic-four-45", "fantastic-four-46", "fantastic-four-47" } },
        new StoryArc { ArcID = "arc-fantastic-four-inhumans-saga-part-3-beware-the-hidden-land", Title = "Inhumans Saga, Part 3: Beware the Hidden Land", IssueIDs = new List<string> { "fantastic-four-36", "fantastic-four-41", "fantastic-four-42", "fantastic-four-43", "fantastic-four-44", "fantastic-four-45", "fantastic-four-46", "fantastic-four-47" } },
        new StoryArc { ArcID = "arc-fantastic-four-worlds-within-worlds", Title = "Worlds Within Worlds", IssueIDs = new List<string> { "fantastic-four-76", "fantastic-four-77", "fantastic-four-280", "fantastic-four-281", "fantastic-four-282", "fantastic-four-283" } },
        new StoryArc { ArcID = "arc-fantastic-four-to-battle-the-living-planet", Title = "To Battle the Living Planet", IssueIDs = new List<string> { "fantastic-four-234", "fantastic-four-235" } },
        new StoryArc { ArcID = "arc-fantastic-four-prey-of-the-black-panther", Title = "Prey of the Black Panther", IssueIDs = new List<string> { "fantastic-four-52", "fantastic-four-53" } },
        new StoryArc { ArcID = "arc-fantastic-four-when-calls-galactus", Title = "When Calls Galactus", IssueIDs = new List<string> { "fantastic-four-242", "fantastic-four-243", "fantastic-four-244" } },
        new StoryArc { ArcID = "arc-fantastic-four-nightmare-in-green", Title = "Nightmare in Green", IssueIDs = new List<string> { "fantastic-four-12" } },
        new StoryArc { ArcID = "arc-fantastic-four-behold-a-distant-star", Title = "Behold, a Distant Star", IssueIDs = new List<string> { "fantastic-four-32", "fantastic-four-37" } },
        new StoryArc { ArcID = "arc-fantastic-four-hopelessly-impossible", Title = "Hopelessly Impossible", IssueIDs = new List<string> { "fantastic-four-11" } },
        new StoryArc { ArcID = "arc-fantastic-four-the-sentry-sinister", Title = "The Sentry Sinister", IssueIDs = new List<string> { "fantastic-four-64" } },
        new StoryArc { ArcID = "arc-fantastic-four-doomsday", Title = "Doomsday", IssueIDs = new List<string> { "fantastic-four-57", "fantastic-four-60" } },
        new StoryArc { ArcID = "arc-the-ultimates", Title = "The Ultimates", Description = "Written by Mark Millar with art by Bryan Hitch",IssueIDs = new List<string> { "the-ultimates-1", "the-ultimates-2", "the-ultimates-3", "the-ultimates-4", "the-ultimates-5", "the-ultimates-6", "the-ultimates-7", "the-ultimates-8", "the-ultimates-9", "the-ultimates-10", "the-ultimates-11", "the-ultimates-12", "the-ultimates-13" } },

        new StoryArc { ArcID = "arc-wonder-woman-gods-and-mortals", Title = "Wonder Woman: Gods and Mortals",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-green-lantern", Title = "Green Lantern",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-batman-a-death-in-the-family", Title = "Batman: A Death in the Family",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-new-blood", Title = "New Blood",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-what-price-honor", Title = "What Price Honor?",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-mogo-doesn-t-socialize", Title = "Mogo Doesn't Socialize",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-tygers", Title = "Tygers",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-what-s-so-funny-about-truth-justice-and-the-american-way", Title = "What's So Funny About Truth, Justice, and the American Way?",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-superman-brainiac", Title = "Superman: Brainiac",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-gotham-by-gaslight", Title = "Gotham by Gaslight",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-injustice-gods-among-us", Title = "Injustice: Gods Among Us",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-batman-knightfall", Title = "Batman: Knightfall",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-the-invincible-iron-man", Title = "The Invincible Iron Man",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-doctor-strange-the-sorcerer-supreme", Title = "Doctor Strange: The Sorcerer Supreme",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-next-avengers-heroes-of-tomorrow", Title = "Next Avengers: Heroes of Tomorrow",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-hulk-vs-thor", Title = "Hulk vs. Thor",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-hulk-vs-wolverine", Title = "Hulk vs. Wolverine",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-thor-tales-of-asgard", Title = "Thor Tales of Asgard",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-deadly-reunions", Title = "X-Men: Deadly Reunions",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-cold-vengeance", Title = "X-Men: Cold Vengeance",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-till-death-do-us-part", Title = "X-Men: Till Death Do Us Part",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-love-in-vain", Title = "X-Men: Love in Vain",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-whatever-it-takes", Title = "X-Men: Whatever It Takes",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-red-dawn", Title = "X-Men: Red Dawn",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-time-fugitives", Title = "X-Men: Time Fugitives",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-beauty-and-the-beast", Title = "X-Men: Beauty and the Beast",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-mojovision", Title = "X-Men: Mojovision",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-out-of-the-past", Title = "X-Men: Out of the Past",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-len-wein", Title = "X-Men: Len Wein",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-the-cry-of-the-banshee", Title = "X-Men: The Cry of the Banshee",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-the-starjammers", Title = "X-Men: The Starjammers",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-no-mutant-is-an-island", Title = "X-Men: No Mutant is an Island",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-obsession", Title = "X-Men: Obsession",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-longshot", Title = "X-Men: Longshot",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-cold-comfort", Title = "X-Men: Cold Comfort",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-savage-land-strange-heart", Title = "X-Men: Savage Land: Strange Heart",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-x-men-dark-phoenix-saga", Title = "X-Men: Dark Phoenix Saga",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-alien-costume", Title = "Spider-Man: The Alien Costume",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-hobgoblin", Title = "Spider-Man: The Hobgoblin",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-coming-of-hydroman", Title = "Spider-Man: The Coming of Hydroman",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-mutants-revenge", Title = "Spider-Man: Mutants Revenge",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-duel-of-the-hunters", Title = "Spider-Man: Duel of the Hunters",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-blade-the-vampire-hunter", Title = "Spider-Man: Blade the Vampire Hunter",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-immortal-vampire", Title = "Spider-Man: The Immortal Vampire",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-doctor-strange", Title = "Spider-Man: Doctor Strange",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-make-a-wish", Title = "Spider-Man: Make a Wish",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-attack-of-the-octobot", Title = "Spider-Man: Attack of the Octobot",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-enter-the-green-goblin", Title = "Spider-Man: Enter the Green Goblin",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-rocket-racer", Title = "Spider-Man: Rocket Racer",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-framed", Title = "Spider-Man: Framed",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-man-without-fear", Title = "Spider-Man: The Man Without Fear",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-cat", Title = "Spider-Man: The Cat",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-return-of-kraven", Title = "Spider-Man: The Return of Kraven",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-partners", Title = "Spider-Man: Partners",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-awakening", Title = "Spider-Man: The Awakening",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-vampire-queen", Title = "Spider-Man: The Vampire Queen",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-haunting-of-mary-jane-watson", Title = "Spider-Man: The Haunting of Mary Jane Watson",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-lizard-king", Title = "Spider-Man: The Lizard King",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-prowler", Title = "Spider-Man: The Prowler",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-unclaimed-legacy", Title = "Spider-Man: Unclaimed Legacy",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-secrets-of-the-six", Title = "Spider-Man: Secrets of the Six",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-six-fight-again", Title = "Spider-Man: The Six Fight Again",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-price-of-heroism", Title = "Spider-Man: The Price of Heroism",IssueIDs = new List<string> { } },
        new StoryArc { ArcID = "arc-spider-man-the-return-of-hydro-man", Title = "Spider-Man: The Return of Hydro-Man",IssueIDs = new List<string> { } },
    ...
    public static CollectedEdition[] GetCollectedEditions() {
      return new CollectedEdition[] {
        new CollectedEdition { EditionID = "book-dc-compact-batman-the-court-of-owls-saga", Line = "DC Compact Comics", Title = "Batman: The Court of Owls Saga", Format = "Softcover (Digest)", ReleaseMonth = 6, ReleaseDay = 4, ReleaseYear = 2024, CollectedIssueIDs = new List<string> { "batman-volume-2-1", "batman-volume-2-2", "batman-volume-2-3", "batman-volume-2-4", "batman-volume-2-5", "batman-volume-2-6", "batman-volume-2-7", "batman-volume-2-8", "batman-volume-2-9", "batman-volume-2-10", "batman-volume-2-11" } },
        ...
        new CollectedEdition { EditionID = "book-dc-compact-batman-under-the-red-hood", Line = "DC Compact Comics", Title = "Batman: Under the Red Hood", Format = "Softcover (Digest)", ReleaseMonth = 6, ReleaseDay = 16, ReleaseYear = 2026, CollectedIssueIDs = new List<string> { "batman-635", "batman-636", "batman-637", "batman-638", "batman-639", "batman-640", "batman-641", "batman-645", "batman-646", "batman-647", "batman-648", "batman-649", "batman-650", "annual-batman-25" } },
        ...
        new CollectedEdition { EditionID = "book-dc-compact-batman-and-son", Line = "DC Compact Comics", Title = "Batman and Son", Format = "Softcover (Digest)", ReleaseMonth = 8, ReleaseDay = 18, ReleaseYear = 2026, CollectedIssueIDs = new List<string> { "batman-655", "batman-656", "batman-657", "batman-658", "batman-663", "batman-664", "batman-665" } },
        ...
        new CollectedEdition { EditionID = "book-dc-compact-100-bullets-first-shot-last-call", Line = "DC Compact Comics", Title = "100 Bullets: First Shot, Last Call", Format = "Softcover (Digest)", ReleaseMonth = 1, ReleaseDay = 5, ReleaseYear = 2027, CollectedIssueIDs = new List<string> { "Vertigo-Winters-Edge-3", "100-bullets-1", "100-bullets-2", "100-bullets-3", "100-bullets-4", "100-bullets-5" } },
        new CollectedEdition { EditionID = "book-dc-compact-preacher-gone-to-texas", Line = "DC Compact Comics", Title = "Preacher: Gone to Texas", Format = "Softcover (Digest)", ReleaseMonth = 1, ReleaseDay = 5, ReleaseYear = 2027, CollectedIssueIDs = new List<string> { "preacher-1", "preacher-2", "preacher-3", "preacher-4", "preacher-5", "preacher-6", "preacher-7" } },
        new CollectedEdition { EditionID = "book-dc-compact-wonder-woman-year-one", Line = "DC Compact Comics", Title = "Wonder Woman: Year One", Format = "Softcover (Digest)", ReleaseMonth = 3, ReleaseDay = 2, ReleaseYear = 2027, CollectedIssueIDs = new List<string> {  } },
        new CollectedEdition { EditionID = "book-dc-compact-superman-man-of-steel", Line = "DC Compact Comics", Title = "Superman: Man of Steel", Format = "Softcover (Digest)", ReleaseMonth = 3, ReleaseDay = 16, ReleaseYear = 2027, CollectedIssueIDs = new List<string> { } },
        new CollectedEdition { EditionID = "book-dc-compact-john-constantine-hellblazer-dangerous-habits", Line = "DC Compact Comics", Title = "John Constantine, Hellblazer: Dangerous Habits", Format = "Softcover (Digest)", ReleaseMonth = 4, ReleaseDay = 13, ReleaseYear = 2027, CollectedIssueIDs = new List<string> { } },
        new CollectedEdition { EditionID = "book-dc-compact-catwoman-when-in-rome", Line = "DC Compact Comics", Title = "Catwoman: When in Rome", Format = "Softcover (Digest)", ReleaseMonth = 4, ReleaseDay = 27, ReleaseYear = 2027, CollectedIssueIDs = new List<string> { "catwoman-when-in-rome-1", "catwoman-when-in-rome-2", "catwoman-when-in-rome-3", "catwoman-when-in-rome-4", "catwoman-when-in-rome-5", "catwoman-when-in-rome-6" } },
        new CollectedEdition { EditionID = "book-dc-compact-green-lantern-rebirth", Line = "DC Compact Comics", Title = "Green Lantern: Rebirth", Format = "Softcover (Digest)", ReleaseMonth = 6, ReleaseDay = 1, ReleaseYear = 2027, CollectedIssueIDs = new List<string> {  } },
        new CollectedEdition { EditionID = "book-dc-compact-superman-brainiac", Line = "DC Compact Comics", Title = "Superman: Brainiac", Format = "Softcover (Digest)", ReleaseMonth = 6, ReleaseDay = 1, ReleaseYear = 2027, CollectedIssueIDs = new List<string> { } },
        new CollectedEdition { EditionID = "book-dc-compact-jla-the-tower-of-babel", Line = "DC Compact Comics", Title = "JLA: The Tower of Babel", Format = "Softcover (Digest)", ReleaseMonth = 6, ReleaseDay = 29, ReleaseYear = 2027, CollectedIssueIDs = new List<string> {  } },

        // Marvel Comics
        new CollectedEdition { EditionID = "book-marvel-compact-black-panther-a-nation-under-our-feet", Line = "Marvel Compact Comics", Title = "Black Panther: A Nation Under Our Feet", Format = "Softcover (Digest)", ReleaseMonth = 2, ReleaseDay = 4, ReleaseYear = 2025, CollectedIssueIDs = new List<string> { "black-panther-volume-5-1", "black-panther-volume-5-2", "black-panther-volume-5-3", "black-panther-volume-5-4", "black-panther-volume-5-5", "black-panther-volume-5-6", "black-panther-volume-5-7", "black-panther-volume-5-8", "black-panther-volume-5-9", "black-panther-volume-5-10", "black-panther-volume-5-11", "black-panther-volume-5-12" } },
        new CollectedEdition { EditionID = "book-marvel-compact-daredevil-born-again", Line = "Marvel Compact Comics", Title = "Daredevil: Born Again", Format = "Softcover (Digest)", ReleaseMonth = 2, ReleaseDay = 4, ReleaseYear = 2025, CollectedIssueIDs = new List<string> { "daredevil-volume-1-226", "daredevil-volume-1-227", "daredevil-volume-1-228", "daredevil-volume-1-229", "daredevil-volume-1-230", "daredevil-volume-1-231", "daredevil-volume-1-232", "daredevil-volume-1-233" } },
        new CollectedEdition { EditionID = "book-marvel-compact-captain-america-the-winter-soldier", Line = "Marvel Compact Comics", Title = "Captain America: The Winter Soldier", Format = "Softcover (Digest)", ReleaseMonth = 4, ReleaseDay = 1, ReleaseYear = 2025, CollectedIssueIDs = new List<string> { "captain-america-volume-5-1", "captain-america-volume-5-2", "captain-america-volume-5-3", "captain-america-volume-5-4", "captain-america-volume-5-5", "captain-america-volume-5-6", "captain-america-volume-5-7", "captain-america-volume-5-8", "captain-america-volume-5-9", "captain-america-volume-5-10", "captain-america-volume-5-11", "captain-america-volume-5-12" } },
        new CollectedEdition { EditionID = "book-marvel-compact-fantastic-four-solve-everything", Line = "Marvel Compact Comics", Title = "Fantastic Four: Solve Everything", Format = "Softcover (Digest)", ReleaseMonth = 6, ReleaseDay = 3, ReleaseYear = 2025, CollectedIssueIDs = new List<string> { "fantastic-four-570", "fantastic-four-571", "fantastic-four-572", "fantastic-four-573", "fantastic-four-574", "fantastic-four-575", "fantastic-four-576", "fantastic-four-577", "fantastic-four-578", "fantastic-four-579", "fantastic-four-580", "fantastic-four-581", "fantastic-four-582", "fantastic-four-583", "fantastic-four-584", "fantastic-four-585", "fantastic-four-586", "fantastic-four-587", "fantastic-four-588" } },
        new CollectedEdition { EditionID = "book-marvel-compact-civil-war", Line = "Marvel Compact Comics", Title = "Civil War", Format = "Softcover (Digest)", ReleaseMonth = 8, ReleaseDay = 5, ReleaseYear = 2025, CollectedIssueIDs = new List<string> { "civil-war-1", "civil-war-2", "civil-war-3", "civil-war-4", "civil-war-5", "civil-war-6", "civil-war-7" } },
        new CollectedEdition { EditionID = "book-marvel-compact-wolverine-old-man-logan", Line = "Marvel Compact Comics", Title = "Wolverine: Old Man Logan", Format = "Softcover (Digest)", ReleaseMonth = 10, ReleaseDay = 21, ReleaseYear = 2025, CollectedIssueIDs = new List<string> { "wolverine-volume-3-66", "wolverine-volume-3-67", "wolverine-volume-3-68", "wolverine-volume-3-69", "wolverine-volume-3-70", "wolverine-volume-3-71", "wolverine-volume-3-72", "wolverine-old-man-logan-giant-size-1" } },
        new CollectedEdition { EditionID = "book-marvel-compact-hawkeye-my-life-as-a-weapon", Line = "Marvel Compact Comics", Title = "Hawkeye: My Life As A Weapon", Format = "Softcover (Digest)", ReleaseMonth = 11, ReleaseDay = 25, ReleaseYear = 2025, CollectedIssueIDs = new List<string> { "hawkeye-volume-4-1", "hawkeye-volume-4-2", "hawkeye-volume-4-3", "hawkeye-volume-4-4", "hawkeye-volume-4-5", "hawkeye-volume-4-6", "hawkeye-volume-4-7", "hawkeye-volume-4-8", "hawkeye-volume-4-9", "hawkeye-volume-4-10", "hawkeye-volume-4-11", "young-avengers-presents-6" } },
        new CollectedEdition { EditionID = "book-marvel-compact-punisher-welcome-back-frank", Line = "Marvel Compact Comics", Title = "Punisher: Welcome Back, Frank", Format = "Softcover (Digest)", ReleaseMonth = 3, ReleaseDay = 10, ReleaseYear = 2026, CollectedIssueIDs = new List<string> { "punisher-volume-5-1", "punisher-volume-5-2", "punisher-volume-5-3", "punisher-volume-5-4", "punisher-volume-5-5", "punisher-volume-5-6", "punisher-volume-5-7", "punisher-volume-5-8", "punisher-volume-5-9", "punisher-volume-5-10", "punisher-volume-5-11", "punisher-volume-5-12" } },
        new CollectedEdition { EditionID = "book-marvel-compact-planet-hulk", Line = "Marvel Compact Comics", Title = "Planet Hulk", Format = "Softcover (Digest)", ReleaseMonth = 5, ReleaseDay = 12, ReleaseYear = 2026, CollectedIssueIDs = new List<string> { "incredible-hulk-volume-2-92", "incredible-hulk-volume-2-93", "incredible-hulk-volume-2-94", "incredible-hulk-volume-2-95", "incredible-hulk-volume-2-96", "incredible-hulk-volume-2-97", "incredible-hulk-volume-2-98", "incredible-hulk-volume-2-99", "incredible-hulk-volume-2-100", "incredible-hulk-volume-2-101", "incredible-hulk-volume-2-102", "giant-size-hulk-1" } },
        new CollectedEdition { EditionID = "book-marvel-compact-the-visions", Line = "Marvel Compact Comics", Title = "The Visions", Format = "Softcover (Digest)", ReleaseMonth = 6, ReleaseDay = 2, ReleaseYear = 2026, CollectedIssueIDs = new List<string> { "vision-2015-1", "vision-2015-2", "vision-2015-3", "vision-2015-4", "vision-2015-5", "vision-2015-6", "vision-2015-7", "vision-2015-8", "vision-2015-9", "vision-2015-10", "vision-2015-11", "vision-2015-12" } },
        new CollectedEdition { EditionID = "book-marvel-compact-spider-men-worlds-collide", Line = "Marvel Compact Comics", Title = "Spider-Men: Worlds Collide", Format = "Softcover (Digest)", ReleaseMonth = 7, ReleaseDay = 7, ReleaseYear = 2026, CollectedIssueIDs = new List<string> { "spider-men-1", "spider-men-2", "spider-men-3", "spider-men-4", "spider-men-5", "spider-men-ii-1", "spider-men-ii-2", "spider-men-ii-3", "spider-men-ii-4", "spider-men-ii-5" } },
        new CollectedEdition { EditionID = "book-marvel-compact-avengers-time-runs-out", Line = "Marvel Compact Comics", Title = "Avengers: Time Runs Out", Format = "Softcover (Digest)", ReleaseMonth = 8, ReleaseDay = 18, ReleaseYear = 2026, CollectedIssueIDs = new List<string> { "avengers-2012-35", "avengers-2012-36", "avengers-2012-37", "avengers-2012-38", "avengers-2012-39", "avengers-2012-40", "avengers-2012-41", "avengers-2012-42", "avengers-2012-43", "avengers-2012-44", "new-avengers-2013-24", "new-avengers-2013-25", "new-avengers-2013-26", "new-avengers-2013-27", "new-avengers-2013-28", "new-avengers-2013-29", "new-avengers-2013-30", "new-avengers-2013-31", "new-avengers-2013-32", "new-avengers-2013-33" } },
        new CollectedEdition { EditionID = "book-marvel-compact-secret-wars", Line = "Marvel Compact Comics", Title = "Secret Wars", Format = "Softcover (Digest)", ReleaseMonth = 8, ReleaseDay = 18, ReleaseYear = 2026, CollectedIssueIDs = new List<string> { "secret-wars-2015-1", "secret-wars-2015-2", "secret-wars-2015-3", "secret-wars-2015-4", "secret-wars-2015-5", "secret-wars-2015-6", "secret-wars-2015-7", "secret-wars-2015-8", "secret-wars-2015-9", "secret-wars-2015-10", "secret-wars-2015-11", "secret-wars-2015-12" } },
        new CollectedEdition { EditionID = "book-marvel-compact-all-new-x-men-yesterday-s-x-men", Line = "Marvel Compact Comics", Title = "All-New X-Men: Yesterday's X-Men", Format = "Softcover (Digest)", ReleaseMonth = 10, ReleaseDay = 6, ReleaseYear = 2026, CollectedIssueIDs = new List<string> { "all-new-x-men-2012-1", "all-new-x-men-2012-2", "all-new-x-men-2012-3", "all-new-x-men-2012-4", "all-new-x-men-2012-5", "all-new-x-men-2012-6", "all-new-x-men-2012-7", "all-new-x-men-2012-8", "all-new-x-men-2012-9", "all-new-x-men-2012-10", "all-new-x-men-2012-11", "all-new-x-men-2012-12" } },
        new CollectedEdition { EditionID = "book-marvel-compact-captain-america-the-death-of-captain-america", Line = "Marvel Compact Comics", Title = "Captain America: The Death of Captain America", Format = "Softcover (Digest)", ReleaseMonth = 11, ReleaseDay = 3, ReleaseYear = 2026, CollectedIssueIDs = new List<string> { "captain-america-2004-22", "captain-america-2004-23", "captain-america-2004-24", "captain-america-2004-25", "captain-america-2004-26", "captain-america-2004-27", "captain-america-2004-28", "captain-america-2004-29", "captain-america-2004-30", "winter-soldier-winter-kills-1" } },
      };
    }
    ...
    public static Media[] GetMedia() {
      return new Media[] {
        ...
        new Media { MediaID = "media-batman-vs-robin", Title = "Batman vs. Robin", MediaType = MediaType.Movie, ReleaseYear = 2015, Description = "Sequel to Son of Batman", AdaptedFromArcIDs = new List<string> { "arc-batman-the-court-of-owls-saga", "arc-batman-and-robin-born-to-kill", "arc-detective-comics-faces-of-death" } },
        ...
        new Media { MediaID = "media-justice-league-the-new-frontier", Title = "Justice League: The New Frontier", MediaType = MediaType.Movie, ReleaseYear = 2008, AdaptedFromArcIDs = new List<string> { "arc-justice-league-the-new-frontier" } },
        ...
        new Media { MediaID = "media-batman-under-the-red-hood", Title = "Batman: Under the Red Hood", MediaType = MediaType.Movie, ReleaseYear = 2010, AdaptedFromArcIDs = new List<string> { "arc-batman-a-death-in-the-family", "arc-batman-under-the-red-hood" } },
        ...
        new Media { MediaID = "media-x-men-animated-series-2-1", Title = "X-Men Animated Series: Season 2, Episode 1: Till Death Do Us Part Part 1", MediaType = MediaType.TVShow, ReleaseYear = 1993, ReleaseMonth = 10, ReleaseDay = 23, AdaptedFromArcIDs = new List<string> { "arc-x-men-till-death-do-us-part" } },
        new Media { MediaID = "media-x-men-animated-series-2-2", Title = "X-Men Animated Series: Season 2, Episode 2: Till Death Do Us Part Part 2", MediaType = MediaType.TVShow, ReleaseYear = 1993, ReleaseMonth = 10, ReleaseDay = 30, AdaptedFromArcIDs = new List<string> { "arc-x-men-till-death-do-us-part" } },
        ...
        new Media { MediaID = "media-x-men-animated-series-2-7", Title = "X-Men Animated Series: Season 2, Episode 7: Time Fugitives Part 1", MediaType = MediaType.TVShow, ReleaseYear = 1993, ReleaseMonth = 12, ReleaseDay = 4, AdaptedFromArcIDs = new List<string> { "arc-x-men-time-fugitives" } },
        new Media { MediaID = "media-x-men-animated-series-2-8", Title = "X-Men Animated Series: Season 2, Episode 8: Time Fugitives Part 2", MediaType = MediaType.TVShow, ReleaseYear = 1993, ReleaseMonth = 12, ReleaseDay = 11, AdaptedFromArcIDs = new List<string> { "arc-x-men-time-fugitives" } },
        ...
        new Media { MediaID = "media-x-men-animated-series-4-1", Title = "X-Men Animated Series: Season 4, Episode 1: The Juggernaut Returns", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 5, ReleaseDay = 6, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-2", Title = "X-Men Animated Series: Season 4, Episode 2: A Deal with the Devil", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 9, ReleaseDay = 14, AdaptedFromArcIDs = new List<string> { } },
        ...
        new Media { MediaID = "media-x-men-animated-series-4-5", Title = "X-Men Animated Series: Season 4, Episode 5: Xavier Remembers", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 10, ReleaseDay = 5, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-6", Title = "X-Men Animated Series: Season 4, Episode 6: Courage", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 10, ReleaseDay = 12, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-7", Title = "X-Men Animated Series: Season 4, Episode 7: Secrets, Not Long Buried", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 10, ReleaseDay = 19, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-8", Title = "X-Men Animated Series: Season 4, Episode 8: Nightcrawler", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 10, ReleaseDay = 26, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-9", Title = "X-Men Animated Series: Season 4, Episode 9: One Man's Worth", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 11, ReleaseDay = 2, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-10", Title = "X-Men Animated Series: Season 4, Episode 10: Longshot", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 11, ReleaseDay = 9, AdaptedFromArcIDs = new List<string> { } },
        new Media { MediaID = "media-x-men-animated-series-4-11", Title = "X-Men Animated Series: Season 4, Episode 11: Proteus Part 1", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 11, ReleaseDay = 16, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-12", Title = "X-Men Animated Series: Season 4, Episode 12: Proteus Part 2", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 11, ReleaseDay = 23, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-13", Title = "X-Men Animated Series: Season 4, Episode 13: Family Ties", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 11, ReleaseDay = 30, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-14", Title = "X-Men Animated Series: Season 4, Episode 14: Bloodlines", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 12, ReleaseDay = 7, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-15", Title = "X-Men Animated Series: Season 4, Episode 15: Lotus and the Steel", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 12, ReleaseDay = 14, AdaptedFromArcIDs = new List<string> {  } },
        ...
        new Media { MediaID = "media-x-men-animated-series-4-17", Title = "X-Men Animated Series: Season 4, Episode 17: Have Yourself a Morlock Little X-Mas", MediaType = MediaType.TVShow, ReleaseYear = 1995, ReleaseMonth = 12, ReleaseDay = 28, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-18", Title = "X-Men Animated Series: Season 4, Episode 18: Beyond Good and Evil, Part 1: The End of Time", MediaType = MediaType.TVShow, ReleaseYear = 1996, ReleaseMonth = 1, ReleaseDay = 4, AdaptedFromArcIDs = new List<string> {  } },
        new Media { MediaID = "media-x-men-animated-series-4-19", Title = "X-Men Animated Series: Season 4, Episode 19: Beyond Good and Evil, Part 2: Promise of Apocalypse", MediaType = MediaType.TVShow, ReleaseYear = 1996, ReleaseMonth = 1, ReleaseDay = 11, AdaptedFromArcIDs = new List<string> {} },
        new Media { MediaID = "media-x-men-animated-series-4-20", Title = "X-Men Animated Series: Season 4, Episode 20: Beyond Good and Evil, Part 3: The Lazarus Chamber", MediaType = MediaType.TVShow, ReleaseYear = 1996, ReleaseMonth = 1, ReleaseDay = 18, AdaptedFromArcIDs = new List<string> {} },
        new Media { MediaID = "media-x-men-animated-series-4-21", Title = "X-Men Animated Series: Season 4, Episode 21: Beyond Good and Evil, Part 4: End and Beginning", MediaType = MediaType.TVShow, ReleaseYear = 1996, ReleaseMonth = 1, ReleaseDay = 25, AdaptedFromArcIDs = new List<string> {} },
        new Media { MediaID = "media-x-men-animated-series-5-1", Title = "X-Men Animated Series: Season 5, Episode 1: The Phalanx Covenant, Part 1", MediaType = MediaType.TVShow, ReleaseYear = 1996, ReleaseMonth = 9, ReleaseDay = 7, AdaptedFromArcIDs = new List<string> {} },
        new Media { MediaID = "media-x-men-animated-series-5-2", Title = "X-Men Animated Series: Season 5, Episode 2: The Phalanx Covenant, Part 2", MediaType = MediaType.TVShow, ReleaseYear = 1996, ReleaseMonth = 9, ReleaseDay = 14, AdaptedFromArcIDs = new List<string> {} },
        new Media { MediaID = "media-x-men-animated-series-5-3", Title = "X-Men Animated Series: Season 5, Episode 3: Storm Front, Part 1", MediaType = MediaType.TVShow, ReleaseYear = 1996, ReleaseMonth = 11, ReleaseDay = 2, AdaptedFromArcIDs = new List<string> {} },
        new Media { MediaID = "media-x-men-animated-series-5-4", Title = "X-Men Animated Series: Season 5, Episode 4: Storm Front, Part 2", MediaType = MediaType.TVShow, ReleaseYear = 1996, ReleaseMonth = 11, ReleaseDay = 9, AdaptedFromArcIDs = new List<string> {} },
        new Media { MediaID = "media-x-men-animated-series-5-5", Title = "X-Men Animated Series: Season 5, Episode 5: The Fifth Horseman", MediaType = MediaType.TVShow, ReleaseYear = 1997, ReleaseMonth = 2, ReleaseDay = 8, AdaptedFromArcIDs = new List<string> { } },
        new Media { MediaID = "media-x-men-animated-series-5-6", Title = "X-Men Animated Series: Season 5, Episode 6: Jubilee's Fairytale Theatre", MediaType = MediaType.TVShow, ReleaseYear = 1996, ReleaseMonth = 11, ReleaseDay = 16, AdaptedFromArcIDs = new List<string> {} },
        new Media { MediaID = "media-x-men-animated-series-5-7", Title = "X-Men Animated Series: Season 5, Episode 7: Old Soldiers", MediaType = MediaType.TVShow, ReleaseYear = 1997, ReleaseMonth = 2, ReleaseDay = 22, AdaptedFromArcIDs = new List<string> {} },
        new Media { MediaID = "media-x-men-animated-series-5-8", Title = "X-Men Animated Series: Season 5, Episode 8: Hidden Agendas", MediaType = MediaType.TVShow, ReleaseYear = 1997, ReleaseMonth = 9, ReleaseDay = 6, AdaptedFromArcIDs = new List<string> {} },
        new Media { MediaID = "media-x-men-animated-series-5-9", Title = "X-Men Animated Series: Season 5, Episode 9: Descent", MediaType = MediaType.TVShow, ReleaseYear = 1997, ReleaseMonth = 9, ReleaseDay = 13, AdaptedFromArcIDs = new List<string> {} },
        new Media { MediaID = "media-x-men-animated-series-5-10", Title = "X-Men Animated Series: Season 5, Episode 10: Graduation Day", MediaType = MediaType.TVShow, ReleaseYear = 1997, ReleaseMonth = 9, ReleaseDay = 20, AdaptedFromArcIDs = new List<string> { } },
