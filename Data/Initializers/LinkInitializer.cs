  ...
  public static class LinkInitializer {
    ...
    public static Link[] GetLinks() {
      return new Link[] {
        ...
        // Quake1
        // General
        new Link { GameID = "Quake1", Label = "SO YOU WANT TO PLAY SOME QUAKE", Description = "Guide to playing Quake 1",
        ...
        new Link { GameID = "Quake1", Label = "Coolkid speedrun live", Description = "Live speedrun of quake in 17:50",
