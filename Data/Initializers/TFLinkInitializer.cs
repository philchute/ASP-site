    ...
    public static Link[] GetLinks()
    {
      return new Link[]
      {
        ...
        new Link { GameID = "FF", Label = "FF cap on resolve", Description = "FF cap on resolve by FDA",
          LinkType = LinkType.Gameplay, Url = "https://www.youtube.com/watch?v=9131-n5K8ug" },
        ...
        new Link { GameID = "FF", Label = "Fortress Forever tidal Engineer guide", Description = "Engineer guide on tidal", 
          LinkType = LinkType.Gameplay, Url = "https://www.youtube.com/watch?v=XfTEJ8EMTP4" },
