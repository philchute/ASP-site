...
namespace ASP_site.Data.Initializers
{
    public static class TimelineGameInitializer
    {
        ...
        [
            ...
            Timeline("startrekeliteforce", "Star Trek: Voyager - Elite Force", "First-person shooter following the Hazard Team aboard Voyager.", "Raven Software", Genre.FPS, 2376, AgeAppropriateness.Teen, 2000, 9, 20),
            Timeline("startrekeliteforce2", "Star Trek: Elite Force II", "First-person shooter sequel set aboard the Enterprise-E after Nemesis.", "Ritual Entertainment", Genre.FPS, 2379, AgeAppropriateness.Teen, 2003, 6, 18),
            ...
            Timeline("startrekinfinite", "Star Trek: Infinite", "Grand strategy 4X set during The Next Generation.", "Nimble Giant Entertainment", Genre.TBS, 2360, AgeAppropriateness.Teen, 2023, 10, 12),
