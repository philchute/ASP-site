    ...
    public static class YearEntryInitializer
    {
        public static List<YearEntry> GetYearEntries()
        {
            ...
            {               
                ...
                // Star Trek extras that a single Media setting year cannot express
                new YearEntry { Title = "Vulcan First Contact", Type = ContentType.Movie, Age = AgeAppropriateness.Middle, Published = "1996",
                                    Year = 2063, Description = "Zefram Cochrane's first contact with Vulcans, as depicted in Star Trek: First Contact." },
                new YearEntry { Title = "Kelvin Timeline: Narada incident", Type = ContentType.Movie, Age = AgeAppropriateness.Middle, Published = "2009",
                                    Year = 2233, Description = "Nero's attack on the Kelvin, the divergence that begins the 2009 Star Trek reboot." },
                new YearEntry { Title = "Enterprise-B maiden voyage", Type = ContentType.Movie, Age = AgeAppropriateness.Middle, Published = "1994",
                                    Year = 2293, Description = "Kirk is lost in the Nexus during the Enterprise-B's maiden voyage in Star Trek: Generations." },
                new YearEntry { Title = "Dominion War", Type = ContentType.Movie, Age = AgeAppropriateness.Teen, Published = "1998",
                                    Year = 2374, Description = "The Dominion War, spanning Deep Space Nine's later seasons." },
