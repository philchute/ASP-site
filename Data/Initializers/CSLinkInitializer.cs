  ...
  public static class CSLinkInitializer
  {
    ...
    public static Link[] GetLinks()
    {
      return new Link[]
      {
        ...
        new Link { GameID = "cs16", Label = "play-cs.com pool day", Description = "Me playing gun game on fy_pool_day on play-cs.com", 
        ...
        new Link { GameID = "cs2", MapID = "ancient", Label = "The Pros' Approach to Taking Ancient B", Description = "mahone's ancient B guide",
          LinkType = LinkType.Guide, Url = "https://www.youtube.com/watch?v=2NscK6rEVNM" },
        new Link { GameID = "cs2", MapID = "ancient", Label = "The Pros' Approach to Holding Ancient Cave", Description = "mahone's ancient cave guide",
        ...
        new Link { GameID = "cs2", MapID = "inferno", Label = "The History of Inferno Banana Control", Description = "The History of Inferno Banana Control",
          LinkType = LinkType.Guide, Url = "https://www.youtube.com/watch?v=vGtCJFSiSpE" },
        new Link { GameID = "cs2", MapID = "inferno", Label = "The Pros' Approach to Holding Inferno Apartments", Description = "mahone's inferno apartments guide",
        ...
        new Link { GameID = "cs2", MapID = "mirage", Label = "The Pros' Approach to Holding Mirage A", Description = "mahone's mirage A guide",
          LinkType = LinkType.Guide, Url = "https://www.youtube.com/watch?v=T3X7ibXXncs" },    
        new Link { GameID = "cs2", MapID = "mirage", Label = "The Pros' Approach to Holding Mirage Connector", Description = "mahone's mirage connector guide",
        ...
        new Link { GameID = "cs2", MapID = "nuke", Label = "de_nuke T guide", Description = "mahone's nuke outside guide",
          LinkType = LinkType.Guide, Url = "https://www.youtube.com/watch?v=jXqrtol0vK8" },
        // de_overpass
        ...
        new Link { GameID = "cs2", MapID = "overpass", Label = "de_overpass B site util dump", Description = "overpass B site util dump",
        ...
        new Link { GameID = "cs2", MapID = "anubis", Label = "The Pros' Approach to Holding Anubis Ebox", Description = "mahone's anubis ebox guide",
          LinkType = LinkType.Guide, Url = "https://www.youtube.com/watch?v=TRyPWjVrDr4" },
        // de_cache
