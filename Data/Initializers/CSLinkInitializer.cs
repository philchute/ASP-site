  ...
  public static class CSLinkInitializer
  {
    ...
    public static Link[] GetLinks()
    {
      return new Link[]
      {
        ...
        new Link { MapID = "ancient", Label = "de_ancient CT guide", Description = "sebcs's ancient CT side guide",
          LinkType = LinkType.Guide, Url = "https://www.youtube.com/watch?v=IzL8gOxbpl4" },
        new Link { MapID = "ancient", Label = "de_ancient T guide", Description = "Birds's ancient T side guide",
        ...
        new Link { MapID = "anubis", Label = "de_anubis CT guide", Description = "sebcs's anubis CT side guide",
          LinkType = LinkType.Guide, Url = "https://www.youtube.com/watch?v=zh-1E9vTBHQ" },
        new Link { MapID = "anubis", Label = "de_anubis T guide", Description = "Bird's anubis T side guide",
          LinkType = LinkType.Guide, Url = "https://www.youtube.com/watch?v=_IyaZFHNiVE" },
        new Link { MapID = "anubis", Label = "de_anubis T guide", Description = "Flom's anubis T side guide",
        ...
        new Link { MapID = "dust2", Label = "de_dust2 CT guide", Description = "sebcs's dust2 CT side guide",
        ...
        new Link { MapID = "inferno", Label = "de_inferno CT guide", Description = "sebcs's inferno CT side guide",
          LinkType = LinkType.Guide, Url = "https://www.youtube.com/watch?v=I0PmXuD-KGU" },
        new Link { MapID = "inferno", Label = "de_inferno T guide", Description = "Flom's inferno T side guide",
        ...
        new Link { MapID = "nuke", Label = "de_nuke CT guide", Description = "sebcs's nuke CT side guide",
        ...
        new Link { MapID = "overpass", Label = "de_overpass CT guide", Description = "sebcs's overpass CT side guide",
