    ...
    public static class ChessInitializer
    {
        public static void Initialize(GameContext context)
        {
            ...
            var pieces = new List<ChessPiece>
            {
                ...
                new ChessPiece { PieceID = "Bull", Symbol = "B",
                    Notation = "jBnU", MoveDescription = "Skipbishop plus (1,4) non-jump move and capture",
                    Names = new List<ChessPieceName> { 
                        new ChessPieceName { Name = "Skip Bishop" },
                    } 
                },
                ...
                new ChessPiece { PieceID = "Dabbaba", Symbol = "D",
                    Notation = "D", MoveDescription = "Jumps two squares orthogonally.",
                    Names = new List<ChessPieceName> { 
                        new ChessPieceName { Name = "Dabbaba" },
                    } 
                },
                ...
                new ChessPiece { PieceID = "Khatun", Symbol = "K",
                    Notation = "cKmN", MoveDescription = "Captures like a King but moves like a Knight.",
                },
                ...
                new ChessPiece { PieceID = "Shepherd", Symbol = "Sh",
                    Notation = "jBAGR2", MoveDescription = "jBAGR2.",
                    Names = new List<ChessPieceName> { 
                        new ChessPieceName { Name = "Shepherd" },
                    } 
                },
            ...
            var armyDefinitions = new List<ChessVariant>
            {
                ...
                new ChessVariant{ 
                    ...
                    Placements = new List<ChessArmyPlacement> {
                        new ChessArmyPlacement { PieceId = "Rook", Rank = 0, File = 0 },
                        new ChessArmyPlacement { PieceId = "Knibi", Rank = 0, File = 1 },
                        new ChessArmyPlacement { PieceId = "Bishkni", Rank = 0, File = 2 },
                        new ChessArmyPlacement { PieceId = "Queen", Rank = 0, File = 3 },
                        new ChessArmyPlacement { PieceId = "King", Rank = 0, File = 4 },
                        new ChessArmyPlacement { PieceId = "Bishkni", Rank = 0, File = 5 },
                        new ChessArmyPlacement { PieceId = "Knibi", Rank = 0, File = 6 },
                        new ChessArmyPlacement { PieceId = "Rook", Rank = 0, File = 7 },
                        new ChessArmyPlacement { PieceId = "Pawn", Rank = 1, File = 0 },
                        new ChessArmyPlacement { PieceId = "Pawn", Rank = 1, File = 1 },
                        new ChessArmyPlacement { PieceId = "Pawn", Rank = 1, File = 2 },
                ...
                new ChessVariant{
                    ...
                    Placements = new List<ChessArmyPlacement> {
                        new ChessArmyPlacement { PieceId = "Ouroboros", Rank = 0, File = 0 },
                        ...
                        new ChessArmyPlacement { PieceId = "CopperGeneral", Rank = 0, File = 6, Name = "Flying Goose" },
                        new ChessArmyPlacement { PieceId = "Ouroboros", Rank = 0, File = 7 },
                        new ChessArmyPlacement { PieceId = "Pawn", Rank = 1, File = 0 },
                        new ChessArmyPlacement { PieceId = "Pawn", Rank = 1, File = 1 },
                        new ChessArmyPlacement { PieceId = "Pawn", Rank = 1, File = 2 },
                        new ChessArmyPlacement { PieceId = "Pawn", Rank = 1, File = 3 },
             ...
             var variants = new List<ChessVariant>
            {
                ...
                new ChessVariant
                {
                    ...
                    Placements = new List<ChessArmyPlacement> {
                        ...
                        new ChessArmyPlacement { PieceId = "Pawn", Rank = 3, File = 8, PromotesTo = "Alfil" },
                    }
                },
                new ChessVariant
                {
                ...
                new ChessVariant
                {
                    ...
                    Placements = new List<ChessArmyPlacement> {
                        new ChessArmyPlacement { PieceId = "Rook", Rank = 0, File = 0 },
                        new ChessArmyPlacement { PieceId = "DragonKing", Rank = 0, File = 1, Name = "Crowned Rook" },
                        new ChessArmyPlacement { PieceId = "Knight", Rank = 0, File = 2 },
                        new ChessArmyPlacement { PieceId = "Bishop", Rank = 0, File = 3 },
                ...
                new ChessVariant
                {
                    ...
                    Placements = new List<ChessArmyPlacement> {
                        ...
                        new ChessArmyPlacement { PieceId = "Knight", Rank = 0, File = 1 },
                        new ChessArmyPlacement { PieceId = "Bishop", Rank = 0, File = 2 },
                        new ChessArmyPlacement { PieceId = "Bishroo", Rank = 0, File = 3, Name = "Biok" },
                        new ChessArmyPlacement { PieceId = "Queen", Rank = 0, File = 4 },
                        new ChessArmyPlacement { PieceId = "King", Rank = 0, File = 5 },
                ...
                new ChessVariant
                {
                    ...
                    Placements = new List<ChessArmyPlacement> {
                        ...
                        new ChessArmyPlacement { PieceId = "Pegasus", Rank = 0, File = 1, Name = "Nightrider Hopper" },
                        ...
                        new ChessArmyPlacement { PieceId = "Pegasus", Rank = 0, File = 8, Name = "Nightrider Hopper" },
                ...
                new ChessVariant
                {
                    ...
                    Placements = new List<ChessArmyPlacement> {
                        ...
                        new ChessArmyPlacement { PieceId = "F2", Rank = 1, File = 2, Name = "Flying Dragon" },
                        new ChessArmyPlacement { PieceId = "Fers", Rank = 1, File = 5, Name = "Fierce Tiger", PromotesTo = "GoldGeneral" },
                        new ChessArmyPlacement { PieceId = "SideMover", Rank = 1, File = 7 },
                        new ChessArmyPlacement { PieceId = "Fers", Rank = 1, File = 9, Name = "Fierce Tiger", PromotesTo = "GoldGeneral" },
                        new ChessArmyPlacement { PieceId = "F2", Rank = 1, File = 11, Name = "Flying Dragon" },
                ...
                new ChessVariant
                {
                    ...
                    Placements = new List<ChessArmyPlacement> {
                        ...
                        new ChessArmyPlacement { PieceId = "F2", Rank = 3, File = 1, Name = "Flying Dragon" },
                        ...
                        new ChessArmyPlacement { PieceId = "F2", Rank = 3, File = 13, Name = "Flying Dragon" },
